...
typedef enum:unsigned char {
	...
	BIT_STK_PROPERTY_UNDEFINED = 0,							// 0x0001
	BIT_STK_PROPERTY_ZS_INT,								// 0x0002
	BIT_STK_PROPERTY_FLOAT,									// 0x0004
	BIT_STK_PROPERTY_BOOL,									// 0x0008
	BIT_STK_PROPERTY_STRING,								// 0x0010
	BIT_STK_PROPERTY_FUNCTION,								// 0x0020
	BIT_STK_PROPERTY_CLASS,									// 0x0040
	BIT_STK_PROPERTY_SCRIPT_OBJECT,							// 0x0080
	BIT_STK_PROPERTY_MAX,
	//-- VM RUNTIME
	BIT_STK_PROPERTY_IS_VAR_C = BIT_STK_PROPERTY_MAX, 		// 0x0100
	BIT_STK_PROPERTY_PTR_STK,	 							// 0x0200
	BIT_STK_PROPERTY_READ_ONLY,				 				// 0x0400
	BIT_STK_PROPERTY_ATTRIB,								// 0x0800
	MAX_BIT_RUNTIME
...
enum
	:unsigned short {
	MSK_STK_PROPERTY_UNDEFINED = (0x1 << BIT_STK_PROPERTY_UNDEFINED), // let's say a variable not defined...
	MSK_STK_PROPERTY_ZS_INT = (0x1 << BIT_STK_PROPERTY_ZS_INT), // primitive int
	MSK_STK_PROPERTY_FLOAT = (0x1 << BIT_STK_PROPERTY_FLOAT), // primitive number
	MSK_STK_PROPERTY_BOOL = (0x1 << BIT_STK_PROPERTY_BOOL), // primitive bool
	MSK_STK_PROPERTY_STRING = (0x1 << BIT_STK_PROPERTY_STRING), // constant / script var
	MSK_STK_PROPERTY_FUNCTION = (0x1 << BIT_STK_PROPERTY_FUNCTION), // primitive function
	MSK_STK_PROPERTY_CLASS = (0x1 << BIT_STK_PROPERTY_CLASS), // primitive function
	MSK_STK_PROPERTY_SCRIPT_OBJECT = (0x1 << BIT_STK_PROPERTY_SCRIPT_OBJECT) // always is an script class...
...
(stk->properties & MSK_STK_PROPERTY_STRING)
