...
typedef enum:unsigned char {
	...
	BIT_STACK_ELEMENT_PROPERTY_VAR_TYPE_CLASS,										// 0x0080
	BIT_STACK_ELEMENT_PROPERTY_VAR_TYPE_SCRIPT_OBJECT,								// 0x0100
	BIT_STACK_ELEMENT_PROPERTY_VAR_TYPE_MAX,
	//-- VM RUNTIME
	BIT_STACK_ELEMENT_PROPERTY_IS_VAR_C = BIT_STACK_ELEMENT_PROPERTY_VAR_TYPE_MAX, 	// 0x0200
	BIT_STACK_ELEMENT_PROPERTY_PTR_STK,	 											// 0x0400
	BIT_STACK_ELEMENT_PROPERTY_READ_ONLY,				 							// 0x0800
	//BIT_STACK_ELEMENT_PROPERTY_RETURN,											// 0x1000
	MAX_BIT_RUNTIME
...
enum
	...
	MSK_STACK_ELEMENT_PROPERTY_VAR_TYPE_CLASS = (0x1 << BIT_STACK_ELEMENT_PROPERTY_VAR_TYPE_CLASS), // primitive function
...
(stk->properties & MSK_STACK_ELEMENT_PROPERTY_VAR_TYPE_CLASS)
