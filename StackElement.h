...
typedef enum:unsigned char {
	...
	BIT_STACK_ELEMENT_PROPERTY_IS_VAR_STACK_ELEMENT,	 							// 0x0200
	BIT_STACK_ELEMENT_PROPERTY_POP_ONE,				 	 							// 0x0400
	BIT_STACK_ELEMENT_PROPERTY_UNRESOLVED_FUNCTION,		 							// 0x0800
	BIT_STACK_ELEMENT_PROPERTY_CONSTRUCTOR_FUNCTION,	 							// 0x1000
	BIT_STACK_ELEMENT_PROPERTY_IS_VAR_THIS,				 							// 0x2000
	BIT_STACK_ELEMENT_PROPERTY_READ_ONLY,				 							// 0x4000
	MAX_BIT_RUNTIME
