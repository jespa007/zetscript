...
typedef enum:unsigned char {
	...
	BIT_STK_PROPERTY_CLASS,									// 0x0010
	BIT_STK_PROPERTY_SCRIPT_OBJECT,							// 0x0020
	BIT_STK_PROPERTY_MAX,
	//-- VM RUNTIME
	BIT_STK_PROPERTY_IS_VAR_C = BIT_STK_PROPERTY_MAX, 		// 0x0040
	BIT_STK_PROPERTY_PTR_STK,	 							// 0x0080
	BIT_STK_PROPERTY_READ_ONLY,				 				// 0x0100
	BIT_STK_PROPERTY_ATTRIB,								// 0x0200
	BIT_STK_PROPERTY_ARRAY_STK,								// 0x0400
	MAX_BIT_RUNTIME
...
enum
	:unsigned short {
	MSK_STK_PROPERTY_UNDEFINED = 0, // let's say a variable not defined...
