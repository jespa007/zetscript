...
enum
	:unsigned short {
	MSK_STACK_ELEMENT_PROPERTY_VAR_TYPE_UNDEFINED = (0x1 << BIT_STACK_ELEMENT_PROPERTY_VAR_TYPE_UNDEFINED), // is a variable not defined...
	MSK_STACK_ELEMENT_PROPERTY_VAR_TYPE_NULL = (0x1 << BIT_STACK_ELEMENT_PROPERTY_VAR_TYPE_NULL), // null is a assigned var ..
