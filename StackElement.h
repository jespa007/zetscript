...
typedef enum:unsigned char {
	...
	BIT_STACK_ELEMENT_PROPERTY_VAR_TYPE_INTEGER,									// 0x0004
	BIT_STACK_ELEMENT_PROPERTY_VAR_TYPE_FLOAT,										// 0x0008
	BIT_STACK_ELEMENT_PROPERTY_VAR_TYPE_BOOLEAN,									// 0x0010
	BIT_STACK_ELEMENT_PROPERTY_VAR_TYPE_STRING,										// 0x0020
	BIT_STACK_ELEMENT_PROPERTY_VAR_TYPE_FUNCTION,									// 0x0040
	BIT_STACK_ELEMENT_PROPERTY_VAR_TYPE_SCRIPTVAR,									// 0x0080
...
enum
	...
	MSK_STACK_ELEMENT_PROPERTY_VAR_TYPE_OBJECT = (0x1 << BIT_STACK_ELEMENT_PROPERTY_VAR_TYPE_SCRIPTVAR) // always is an script class...
...
(stk->properties & MSK_STACK_ELEMENT_PROPERTY_VAR_TYPE_OBJECT)
