...
namespace ZetScript{
	...
	public:
		...
		bool searchVarFunctionSymbol( std::string symbol_to_find,ByteCode *iao, int current_function, bool & symbol_not_found, unsigned int param_scope_type, int n_args_to_find=-1);
		...
		ScriptFunction * getFunction(const std::string & symbol, short idxScope,char n_args=0);
