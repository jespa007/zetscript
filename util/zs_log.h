//#define zs_print_error_cr(s, ...) 	zetscript::log::print(__FILE__,__LINE__,zetscript::zs_string::LOG_ERROR	, true,s, ##__VA_ARGS__)
...
//#define zs_print_error(s, ...) 			zetscript::log::print(__FILE__,__LINE__,zetscript::zs_string::LOG_ERROR	, false,s, ##__VA_ARGS__)
