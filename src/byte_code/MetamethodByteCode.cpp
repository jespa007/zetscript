...
namespace zetscript{
	...
	const char * metamethod_byte_code_to_operator_str(MetamethodByteCode op){
		switch (op) {
			...
			case	ZS_METAMETHOD_BYTE_CODE_ADD_SET:	return  "+=";		// _set_add
			case	ZS_METAMETHOD_BYTE_CODE_SUB_SET:	return  "-=";		// _set_sub
			case 	ZS_METAMETHOD_BYTE_CODE_MUL_SET:   return  "*=";		// _mulset
			case	ZS_METAMETHOD_BYTE_CODE_DIV_SET:	return  "/=";		// _set_div
			case	ZS_METAMETHOD_BYTE_CODE_MOD_SET:	return  "%=";		// _set_mod
			case	ZS_METAMETHOD_BYTE_CODE_AND_SET:	return  "&=";		// _set_and
			case	ZS_METAMETHOD_BYTE_CODE_OR_SET:	return  "|=";		// _set_or
			case	ZS_METAMETHOD_BYTE_CODE_XOR_SET:	return  "^=";		// _set_xor
			case	ZS_METAMETHOD_BYTE_CODE_SHL_SET:	return  "<<=";		// _set_shl
			case	ZS_METAMETHOD_BYTE_CODE_SHR_SET:	return  ">>=";		// _set_shr
			case	ZS_METAMETHOD_BYTE_CODE_BTW_SET:	return  "~=";		// _set_btw
	...
	const char * metamethod_byte_code_to_symbol_str(MetamethodByteCode op){
		...
		default:
			...
			case	ZS_METAMETHOD_BYTE_CODE_ADD_SET:	return  "_addset";	// _set_add
			case	ZS_METAMETHOD_BYTE_CODE_SUB_SET:	return  "_subset";	// _set_sub
			case	ZS_METAMETHOD_BYTE_CODE_MUL_SET:	return  "_mulset";	// _mulset
			case	ZS_METAMETHOD_BYTE_CODE_DIV_SET:	return  "_divset";	// _set_div
			case	ZS_METAMETHOD_BYTE_CODE_MOD_SET:	return  "_modset";	// _set_mod
			case	ZS_METAMETHOD_BYTE_CODE_AND_SET:	return  "_andset";	// _set_and
			case	ZS_METAMETHOD_BYTE_CODE_OR_SET:	return  "_orset"; 	// _set_or
			case	ZS_METAMETHOD_BYTE_CODE_XOR_SET:	return  "_xorset";	// _set_xor
			case	ZS_METAMETHOD_BYTE_CODE_SHL_SET:	return  "_shlset";	// _set_shl
			case	ZS_METAMETHOD_BYTE_CODE_SHR_SET:	return  "_shrset";	// _set_shr
			case	ZS_METAMETHOD_BYTE_CODE_BTW_SET:	return  "_btw_set";	// _set_btw
