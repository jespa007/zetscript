...
namespace zetscript{
	...
	typedef enum: uint8_t {
		...
		ZS_METAMETHOD_BYTE_CODE_ADD_SET, // set '+='
		ZS_METAMETHOD_BYTE_CODE_SUB_SET, // set '-='
		ZS_METAMETHOD_BYTE_CODE_MUL_SET, // set '*='
		ZS_METAMETHOD_BYTE_CODE_DIV_SET, // set '/='
		ZS_METAMETHOD_BYTE_CODE_MOD_SET, // set '%='
		ZS_METAMETHOD_BYTE_CODE_AND_SET, // set '&='
		ZS_METAMETHOD_BYTE_CODE_OR_SET,  // set '|='
		ZS_METAMETHOD_BYTE_CODE_XOR_SET, // set '^='
		ZS_METAMETHOD_BYTE_CODE_SHL_SET, // set '<<'
		ZS_METAMETHOD_BYTE_CODE_SHR_SET, // set '>>'
		ZS_METAMETHOD_BYTE_CODE_BTW_SET, // set '~'
