...
namespace zetscript{
	...
	typedef enum: uint8_t {
		...
		ZS_METAMETHOD_BYTE_CODE_ADD_ASSIGN, // set '+='
		ZS_METAMETHOD_BYTE_CODE_SUB_ASSIGN, // set '-='
		ZS_METAMETHOD_BYTE_CODE_MUL_ASSIGN, // set '*='
		ZS_METAMETHOD_BYTE_CODE_DIV_ASSIGN, // set '/='
		ZS_METAMETHOD_BYTE_CODE_MOD_ASSIGN, // set '%='
		ZS_METAMETHOD_BYTE_CODE_AND_ASSIGN, // set '&='
		ZS_METAMETHOD_BYTE_CODE_OR_ASSIGN,  // set '|='
		ZS_METAMETHOD_BYTE_CODE_XOR_ASSIGN, // set '^='
		ZS_METAMETHOD_BYTE_CODE_SHL_ASSIGN, // set '<<'
		ZS_METAMETHOD_BYTE_CODE_SHR_ASSIGN, // set '>>'
