...
#define ZS_IS_BYTE_CODE_STORE_WITH_OPERATION(b) 	(ZS_BYTE_CODE_ADD_ASSIGN<=(b) && (b) <=ZS_BYTE_CODE_SHR_ASSIGN)
...
namespace zetscript{
	...
	typedef enum:uint8_t{
		...
		ZS_BYTE_CODE_ADD_ASSIGN, //
		ZS_BYTE_CODE_SUB_ASSIGN, //
		ZS_BYTE_CODE_MUL_ASSIGN, //
		ZS_BYTE_CODE_DIV_ASSIGN, //
		ZS_BYTE_CODE_MOD_ASSIGN, //
		ZS_BYTE_CODE_BITWISE_AND_ASSIGN, //
		ZS_BYTE_CODE_BITWISE_OR_ASSIGN,  //
		ZS_BYTE_CODE_BITWISE_XOR_ASSIGN, //
		ZS_BYTE_CODE_SHL_ASSIGN, //
		ZS_BYTE_CODE_SHR_ASSIGN, //
		ZS_BYTE_CODE_END_STORE=ZS_BYTE_CODE_SHR_ASSIGN,
		//----- END STORE
