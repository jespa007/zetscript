...
#define ZS_IS_BYTE_CODE_STORE_WITH_OPERATION(b) 	(ZS_BYTE_CODE_ADD_ST<=(b) && (b) <=ZS_BYTE_CODE_SHR_ST)
...
namespace zetscript{
	...
	typedef enum:uint8_t{
		...
		ZS_BYTE_CODE_DIV_ST, //
		ZS_BYTE_CODE_MOD_ST, //
		ZS_BYTE_CODE_BITWISE_AND_ST, //
		ZS_BYTE_CODE_BITWISE_OR_ST,  //
		ZS_BYTE_CODE_BITWISE_XOR_ST, //
		ZS_BYTE_CODE_SHL_ST, //
		ZS_BYTE_CODE_SHR_ST, //
		ZS_BYTE_CODE_END_STORE=ZS_BYTE_CODE_SHR_ST,
		//----- END STORE
