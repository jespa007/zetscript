...
#define STK_IS_SCRIPT_OBJECT_ITERATOR_OBJECT(stk)		(((stk)->properties & STK_PROPERTY_SCRIPT_OBJECT) && (((ScriptObject *)(stk)->value)->idx_script_class==IDX_TYPE_SCRIPT_OBJECT_ITERATOR_OBJECT))
...
#define STK_IS_SCRIPT_OBJECT_ITERATOR_STRING(stk)		(((stk)->properties & STK_PROPERTY_SCRIPT_OBJECT) && (((ScriptObject *)(stk)->value)->idx_script_class==IDX_TYPE_SCRIPT_OBJECT_ITERATOR_STRING))
...
#define STK_IS_SCRIPT_OBJECT_ITERATOR_VECTOR(stk)		(((stk)->properties & STK_PROPERTY_SCRIPT_OBJECT) && (((ScriptObject *)(stk)->value)->idx_script_class==IDX_TYPE_SCRIPT_OBJECT_ITERATOR_VECTOR))
