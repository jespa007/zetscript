...
#define ZS_STK_IS_ITERATOR_STRING_SCRIPT_OBJECT(stk)		(((stk)->properties & zetscript::ZS_STK_PROPERTY_SCRIPT_OBJECT) && (((zetscript::ScriptObject *)(stk)->value)->idx_script_type==zetscript::IDX_TYPE_SCRIPT_OBJECT_ITERATOR_STRING))
