...
namespace zetscript{
	...
	char * 	eval_keyword_function(EvalData *eval_data,const char *s,int & line,  Scope *scope_info, uint16_t properties=0,Symbol ** result_symbol_function=NULL, const String  & custom_symbol_name="");
