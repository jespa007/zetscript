...
namespace zetscript{
	...
	#define ZS_EVAL_KEYWORD_FUNCTION_PROPERTY_IS_ANONYMOUS 		0x0001
	#define ZS_EVAL_KEYWORD_FUNCTION_PROPERTY_IS_MEMBER_PROPERTY 	0x0002
	#define ZS_EVAL_KEYWORD_VAR_PROPERTY_ALLOW_IN_OPERATOR			0x0001
