...
namespace zetscript{
	...
	typedef enum{
		...
		EVAL_EXPRESSION_ALLOW_ONE_LOAD_INSTRUCTION		=0x1<<6, // is used in case of eval expressions after '=' (for instance default args and single var assignment and returns). It can eval one load instruction
