...
namespace zetscript{
	 ...
	 zs_float MathModule_degToRad(ScriptEngine *_zs,zs_float *_deg);
	 zs_float MathModule_sin(ScriptEngine *_zs,zs_float *_rad);
	 zs_float MathModule_cos(ScriptEngine *_zs,zs_float *_rad);
	 zs_float MathModule_abs(ScriptEngine *_zs,zs_float *_n);
	 zs_float MathModule_pow(ScriptEngine *_zs,zs_float *_base, zs_float *_exp);
