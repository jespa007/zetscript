...
Integer *IntegerWrap_new(zetscript::ZetScript *_zs){
	return new Integer();
...
void IntegerWrap_set(zetscript::ZetScript *_zs,Integer *_this,Integer *_ci2){
	 _this->n = _ci2->n;
}

Integer * IntegerWrap_add(zetscript::ZetScript *_zs,Integer *n1, Integer *n2){
...
Integer * IntegerWrap_sub(zetscript::ZetScript *_zs,Integer *n1, Integer *n2){
	return new Integer(n1->n - n2->n);
}
...
Integer * IntegerWrap_div(zetscript::ZetScript *_zs,Integer *n1, Integer *n2){
	return new Integer(n1->n / n2->n);
}
...
Integer * IntegerWrap_neg(zetscript::ZetScript *_zs,Integer *n1){
	return new Integer(-n1->n);
}

Integer * IntegerWrap_mod(zetscript::ZetScript *_zs,Integer *n1, Integer *n2){
	return new Integer(n1->n % n2->n);
}
...
Integer * IntegerWrap_mul(zetscript::ZetScript *_zs,Integer *n1, Integer *n2){
	return new Integer(n1->n * n2->n);
}
...
Integer * IntegerWrap_shl(zetscript::ZetScript *_zs,Integer *n1, Integer *n2){
	return new Integer(n1->n << n2->n);
}
...
Integer * IntegerWrap_and(zetscript::ZetScript *_zs,Integer *n1, Integer *n2){
	return new Integer(n1->n & n2->n);
}
...
Integer * IntegerWrap_or(zetscript::ZetScript *_zs,Integer *n1, Integer *n2){
	return new Integer(n1->n | n2->n);
}
...
Integer * IntegerWrap_xor(zetscript::ZetScript *_zs,Integer *n1, Integer *n2){
	return new Integer(n1->n ^ n2->n);
}
...
Integer * IntegerWrap_shr(zetscript::ZetScript *_zs,Integer *n1, Integer *n2){
	return new Integer(n1->n >> n2->n);
}
...
void IntegerWrap_delete(zetscript::ZetScript *_zs,Integer *_this){
	delete _this;
}
