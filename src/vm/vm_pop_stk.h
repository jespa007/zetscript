...
/*#define VM_LOAD_STK_FROM_INSTRUCTION(offset,properties) \
...
#define VM_LOAD_STK_FROM_INSTRUCTION(_stk_result,_offset,_properties) \
...
#define VM_POP_STK_TWO \
	...
	case INSTRUCTION_PROPERTY_ILOAD_R: /* only perfom with one Register */\
		 stk_result_op1=--data->vm_stk_current;\
		 VM_LOAD_STK_FROM_INSTRUCTION(stk_result_op2,instruction->value_op1,instruction->properties);\
		 break;\
	...
	case INSTRUCTION_PROPERTY_ILOAD_RK: /* perfom Register-Konstant */\
		VM_LOAD_STK_FROM_INSTRUCTION(stk_result_op1,instruction->value_op1,instruction->properties);\
		stk_result_op2=&stk_aux1;\
   ...
   case INSTRUCTION_PROPERTY_ILOAD_RR: /* perfom Register-Register*/ \
		VM_LOAD_STK_FROM_INSTRUCTION(stk_result_op1,instruction->value_op1,instruction->properties); \
		VM_LOAD_STK_FROM_INSTRUCTION(stk_result_op2,((instruction->value_op2&0xff0000)>>16),instruction->value_op2); \
		break;\
	}
