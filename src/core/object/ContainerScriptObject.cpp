...
namespace zetscript{
	...
	):ScriptObject(_se, _ref_script_type_id){
		container_slots=new List<ContainerSlot *>;
	}

	List<ContainerSlot *>	*ContainerScriptObject::getListContainerSlotsRef(){
	...
	void ContainerScriptObject::onDettachContainerSlotNode(ListNode<ContainerSlot *> *_current_node){
