...
namespace zetscript{
		...
		public:
			...
			static ClassScriptObject * newClassScriptObject(ScriptEngine *_script_engine,ScriptTypeId _script_type_id,void *  _c_object=NULL);

			ClassScriptObject(ScriptEngine *_script_engine, ScriptTypeId _script_type_id,void *  _c_object=NULL);
