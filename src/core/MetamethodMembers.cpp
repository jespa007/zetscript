...
namespace zetscript{
	...
	MetamethodMemberSetterInfo 		MetamethodMembers::getSetterInfo(const String & _metamethod_name){
	...
	MetamethodMemberGetterInfo MetamethodMembers::getGetterInfo(const String & _metamethod_name){
	...
	bool MetamethodMembers::isSetter(const String & _str){
	...
	bool MetamethodMembers::isGetter(const String & _str){
	...
	MetamethodMembers::~MetamethodMembers(){
		...
		Vector<StackElement *> *ptr_vector[]={
			&setters
			,&add_setters
			,&sub_setters
			,&mul_setters
