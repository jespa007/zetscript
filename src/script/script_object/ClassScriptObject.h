...
namespace zetscript{
		...
		public:
			...
			static ClassScriptObject * newClassScriptObject(ZetScript *_zs,short _idx_type,void *  _c_object=NULL);

			ClassScriptObject(ZetScript *_zs,short _idx_type,void *  _c_object=NULL);
