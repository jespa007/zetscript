...
namespace zetscript{
	...
	//ZS_DECLARE_CONSTRUCTOR_DESTRUCTOR_FUNCTIONS(ScriptObjectContainerSlotAssignment)
	...
	void ScriptTypeFactory::registerSystem(){
		...
		SCF_BIND_SINGLETON_NAME_CLASS(ZS_TYPE_NAME_OBJECT_WEAK_POINTER,ScriptObjectContainerSlotAssignment,IDX_TYPE_SCRIPT_OBJECT_WEAK_POINTER);
