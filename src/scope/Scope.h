...
namespace zetscript{
	...
	public:
		...
		Symbol * registerSymbolFunction(const char * file, short line,const zs_string & symbol_name, size_t n_params,uint16_t  _check_repeteaded_symbols=REGISTER_SCOPE_CHECK_REPEATED_SYMBOLS_UP_AND_DOWN);
