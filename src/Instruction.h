...
typedef enum:unsigned short {
	...
	INSTRUCTION_PROPERTY_RETURN_ALL_STACK			=0x2000
...
#define INSTRUCTION_PROPERTY_ILOAD_ACCESS_IS_GLOBAL(properties) 	((properties) & (INSTRUCTION_PROPERTY_ILOAD_R_ACCESS_LOCAL | INSTRUCTION_PROPERTY_ILOAD_R_ACCESS_THIS_MEMBER) == 0)

#define INSTRUCTION_IS_BYTE_CODE_CALL(instruction) (((instruction)->byte_code == BYTE_CODE_CALL) || ((instruction)->byte_code == BYTE_CODE_IMMEDIATE_CALL))
