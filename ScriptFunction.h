...
#define INSTRUCTION_GET_FILE_LINE(__FUNC__,__INS__) 	((ZetScript::ScriptFunction *)__FUNC__)->INSTRUCTION_getFile(__INS__), ((ZetScript::ScriptFunction *)__FUNC__)->INSTRUCTION_getLine(__INS__)
#define INSTRUCTION_GET_FILE(__FUNC__,__INS__) 			((ZetScript::ScriptFunction *)__FUNC__)->INSTRUCTION_getFile(__INS__)
#define INSTRUCTION_GET_LINE(__FUNC__,__INS__)			((ZetScript::ScriptFunction *)__FUNC__)->INSTRUCTION_getLine(__INS__)
#define INSTRUCTION_GET_SYMBOL_NAME(__FUNC__,__INS__)	((ZetScript::ScriptFunction *)__FUNC__)->INSTRUCTION_getSymbolName(__INS__)
...
namespace ZetScript{
	...
	public:
		...
		short 		 INSTRUCTION_getLine(ByteCode * ins);
		const char * INSTRUCTION_getSymbolName(ByteCode * ins);
		const char * INSTRUCTION_getFile(ByteCode * ins);
	...
	private:
		...
		inline OpCodeInstructionSourceInfo * getInstructionInfo(ByteCode *ins){
			short idx= (ins-this->instruction);///sizeof(ByteCode *);
