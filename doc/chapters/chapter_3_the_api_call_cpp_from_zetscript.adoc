...
To register a C function that accepts a pointer type of a registered class it must specify *ScriptFunction &ast;* as parameter type on its function prototype.
