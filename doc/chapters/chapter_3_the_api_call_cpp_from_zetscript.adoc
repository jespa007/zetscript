...
To call C&plus;&plus; code from _ZetScript_ it has to create and register a C function with a particular prototype. That C function acts as interface between ZetScript and C++. 
...
To register a C function that returns a *xref:chapter_2_the_language_data_types.adoc#_boolean[String]* it can be done by specifying the following return types in its prototype,
...
To register a C function that returns a *xref:chapter_2_the_language_data_types.adoc#_boolean[String]* it can specify *const char &ast;* return type on its function prototype.
...
To register a C function that returns a *xref:chapter_2_the_language_data_types.adoc#_boolean[String]* it can specify *zs_string* return type on its function prototype.
...
To register a C function that returns a *xref:chapter_2_the_language_data_types.adoc#_boolean[String]* it can specify *StringScriptObject &ast;* return type on its function prototype. The instantiation of *StringScriptObject &ast;* it's done throught _ZetScript::newStringScriptObject_ using ZetScript context.

*Prototype*

  StringScriptObject &ast; returnString(ZetScript * _zs);
...
To register a C function that returns a *xref:chapter_2_the_language_data_types.adoc#_boolean[Array]* it must specify *ArrayScriptObject &ast;* return type on its function prototype. The instantiation of *ArrayScriptObject &ast;* it's done through _ZetScript::newArrayScriptObject_ using ZetScript context.

*Prototype*

  ArrayScriptObject &ast; returnString(ZetScript * _zs);
...
To register a C function that returns a *xref:chapter_2_the_language_data_types.adoc#_boolean[Object]* it must specify *ObjectScriptObject &ast;* return type on its function prototype. The instantiation of *ObjectScriptObject &ast;* it's done through _ZetScript::newObjectScriptObject_ using ZetScript context.

*Prototype*

  ObjectScriptObject &ast; returnString(ZetScript * _zs);
...
*Prototype*
  ...
  ClassType &ast; returnClassTypePointer(ZetScript * _zs);
...
To register a C function that returns a *<<Registered Class>>* it can specify *ClassScriptObject &ast;* return type on its function prototype. To instantiate *ClassScriptObject &ast;*  is done through _<<ZetScript::newClassScriptObject>>_ using ZetScript context and the registered class instantiated.

A difference from returning a pointer type of a registered class, when the C function returns a *ClassScriptObject &ast;* object ZetScript is in charge to deallocate automatically when there's no more references. 

To be have the class wrappable inside *ClassScriptObject &ast;*, it must be registered as instancialbe (see <<Register class as instanciable>>)

*Prototype*

  ClassScriptObject &ast; returnClassScriptObject(ZetScript * _zs);
...
*Prototype*
  ...
  void paramBoolean(ZetScript * _zs, bool _value);
...
To register a C function that accepts a *xref:chapter_2_the_language_data_types.adoc#_boolean[Integer]* it must specify *zs_int* as parameter type on its function prototype.

*Prototype*

  void paramInteger(ZetScript * _zs, zs_int _value);
...
To register a C function that accepts a *xref:chapter_2_the_language_data_types.adoc#_boolean[Float]* it must specify *zs_float* as parameter type on its function prototype.

*Prototype*

  void paramFloat(ZetScript * _zs, zs_float _value);
...
To register a C function that accepts a *xref:chapter_2_the_language_data_types.adoc#_boolean[String]* it can specify *const char &ast;* as parameter type on its function prototype.

*Prototype*

  void paramConstChar(ZetScript * _zs, const char * _value);
...
To register a C function that accepts a *xref:chapter_2_the_language_data_types.adoc#_boolean[String]* it can specify *zs_string &ast;* as parameter type on its function prototype.

*Prototype*

  void paramZsString(ZetScript * _zs, zs_string * _value);
...
To register a C function that accepts a *xref:chapter_2_the_language_data_types.adoc#_boolean[String]* it can specify *StringScriptObject &ast;* as parameter type on its function prototype.

*Prototype*

  void paramStringScriptObject(ZetScript * _zs, StringScriptObject * _value);
...
To register a C function that accepts a *xref:chapter_2_the_language_data_types.adoc#_boolean[Array]* it can specify *ArrayScriptObject &ast;* as parameter type on its function prototype.

*Prototype*

  void paramStringScriptObject(ZetScript * _zs, ArrayScriptObject * _value);
...
To register a C function that accepts a *xref:chapter_2_the_language_data_types.adoc#_boolean[Object]* it can specify *ObjectScriptObject &ast;* as parameter type on its function prototype.

*Prototype*

  void paramStringScriptObject(ZetScript * _zs, ObjectScriptObject * _value);
...
To register a C function that accepts a *xref:chapter_2_the_language_data_types.adoc#_boolean[Function]* it can specify *ScriptFunction &ast;* as parameter type on its function prototype. To make  _ScriptFunction_ callable from C++ it must to bind that using <<bindScriptFunction>>.

*Prototype*

  void paramStringScriptObject(ZetScript * _zs, ScriptFunction * _value);
...
A native function that accepts pointer type of a registered class , it must create and register a C function with the C type pointer of the registered class (see section <<Register class>> to know more about how to register a class)
