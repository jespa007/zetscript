...
This section will explain how to register functions that return the following types,
...
To register a function that returns a _Boolean_ value, it must create and register a C function that returns _bool_ as return type.
