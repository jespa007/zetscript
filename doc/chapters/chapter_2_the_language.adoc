...
[source,javascript]
----
include::../examples/the_language/integer_parse.zs[]
----
...
[source,txt]
----
include::../examples/the_language/integer_parse_out.txt[]
----
...
[source,javascript]
----
include::../examples/the_language/float_parse.zs[]
----
...
[source,txt]
----
include::../examples/the_language/float_parse_out.txt[]
----
...
[source,javascript]
----
include::../examples/the_language/string_format.zs[]
----
...
[source,txt]
----
include::../examples/the_language/string_format_out.txt[]
----
...
[source,javascript]
----
include::../examples/the_language/string_to_upper_case.zs[]
----
...
[source,text]
----
include::../examples/the_language/string_to_upper_case_out.txt[]
----
...
[source,javascript]
----
include::../examples/the_language/string_to_lower_case.zs[]
----
...
[source,text]
----
include::../examples/the_language/string_to_lower_case_out.txt[]
----
...
- true :  if the string starts with the specified string passed by __value_
- false:  if the string does not starts with the specified string passed by __value_

*Example*

[source,javascript]
----
include::../examples/the_language/string_starts_with.zs[]
----
...
[source,text]
----
include::../examples/the_language/string_starts_with_out.txt[]
----
...
- true :  if the string ends with the specified string passed by __value_
- false:  if the string does not ends with the specified string passed by __value_

*Example*

[source,javascript]
----
include::../examples/the_language/string_ends_with.zs[]
----
...
[source,text]
----
include::../examples/the_language/string_ends_with_out.txt[]
----
...
[source,javascript]
----
include::../examples/the_language/string_substring.zs[]
----
...
[source,txt]
----
include::../examples/the_language/string_substring_out.txt[]
----
