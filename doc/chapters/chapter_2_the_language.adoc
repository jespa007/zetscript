...
- __position_: Integer that represents the position where to insert. The position ranges within 0 to the length-1 of the String
...
- __position_:  Integer that represents the position where to remove .
