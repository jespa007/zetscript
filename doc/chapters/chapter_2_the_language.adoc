...
The loop for-in works as for loop but simplifies the iteration over containers like string, object or vectors. Per each iteration it returns its value or a pair key-value,
