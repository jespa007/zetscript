...
Implements relational equal (aka == ) operator between first operand and second operand 
...
true if op1 and op2 are equal, false otherwise.

*Example*

[source,javascript]
----
include::../examples/the_language/class/class_metamethod_equal.zs[]
----
...
[source,text]
----
include::../examples/the_language/class/class_metamethod_equal_out.txt[]
----
