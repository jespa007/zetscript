...
|Add 
|+
|It performs a add operation between two integer or float values or concatenates strings with other values
|
[source,javascript]
5+10; // = 15
1.5+6; // = 7.5
...
|Subtract
|-
|It performs a sub operation between two integer or float values
|
[source,javascript]
10-5; // = 5
2.5-1;// = 1.5
...
|Multiply 
|* 
|It performs a multiplication between two integer or float values
|
[source,javascript]
10*5; //= 50
1.5*2;//= 3.0
...
|Divide 
|/ 
|It performs a division between two integer or float values
|
[source,javascript]
10/2; // = 5
3/2.0 // = 1.5
