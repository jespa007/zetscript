...
Integer data operators are applied on integer variables before or after is read. Integer operators are the following,
...
Converts input value as Float

*Parameters*

- __value_ : String or Integer literal or data type
...
Builds a string placing formated values in {} as string with a serie of variable args
