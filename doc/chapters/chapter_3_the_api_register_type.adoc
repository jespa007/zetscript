...
To register C&plus;&plus; class it's done by passing the C&plus;&plus; class or struct type with `ZetScript::registerClass<_Type>(_script_name)`

Syntax



- _T: Struct/Class type type 
