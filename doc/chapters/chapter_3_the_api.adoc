...
Defining _bool_ as type of return it defines a function that returns a boolean value
...
Defining _zs_int_ as type of return it defines a function that returns a integer value
...
Defining _zs_float_ as type of return it defines a function that returns a float value
...
Defining _const char *_ as type of return it defines a function that returns a string as _const char *_ value
...
Defining _StringScriptObject_ as type of return it defines a function that returns a string as _String_ script object. The creation of _StringScriptObject_ it's done with usign _ZetScript_ context.
...
Defining _ArrayScriptObject_ as type of return it defines a function that returns a _Array_ script object. The creation of _ArrayScriptObject_ it's done with usign _ZetScript_ context.
...
Defining _ObjectScriptObject_ as type of return it defines a function that returns a _Object_ script object. The creation of _ObjectScriptObject_ it's done with usign _ZetScript_ context.
