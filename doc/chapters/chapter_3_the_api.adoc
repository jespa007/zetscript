...
To call a C function that returns a registered class (see section <<Register class>> to know more about how to register a class), it can create and register a C function that  returns one the following as return types,
...
A native function that accepts a C type of a registered class, it must create and register a C function with the C type pointer of the registered class (see section <<Register class>> to know more about how to register a class)

*Example*

[source,c++]
----
include::../examples/the_api/register_function/register_function_param_c_type.cpp[]
----
...
[source,txt]
----
include::../examples/the_api/register_function/register_function_param_c_type_out.txt[]
----
