...
This section will explain how to define and register C function to be callable from script side.

The function to register must have signature as it follows,
