...
include::chapter_3_the_api_calling_zetscript_function_from_cpp.adoc[]
include::chapter_3_the_api_byte_codes.adoc[]
include::chapter_3_the_api_register_class.adoc[]
include::chapter_3_the_api_calling_cpp_function_from_zetscript.adoc[]
