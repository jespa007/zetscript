...
_const char *_ it defines a string represented a sequence of chars
...
This section will explain the how to define and bind a native function as function interface to be called from script side.

The native function to bind is defined as C function and always includes `zetscript::ZetScript *` as first parameter and a maximum of 9 parameters as <<built-in types>> or custom types.
...
After having the native function defined, it binds through `ZetScript::bindFunction` function by passing the name of function and the native function reference.
...
The following example it binds a native function called "sayHelloWorld" without arguments and return value.

[source,c++]
----
include::../examples/the_api/bind_native_function/bind_native_function.cpp[]
----
...
[source,txt]
----
include::../examples/the_api/bind_native_function/bind_native_function_out.txt[]
----

==== Return types

In the next sections will explain which kind of types return the following values,
...
A native function that returns a _boolean_ value must define return type as _bool_.

*Example*

[source,c++]
----
include::../examples/the_api/bind_native_function/bind_native_function_return_bool.cpp[]
----
...
[source,txt]
----
include::../examples/the_api/bind_native_function/bind_native_function_return_bool_out.txt[]
----


===== Integer

A native function that returns a _integer_ value must define return type as _zs_int_.

*Example*

[source,c++]
----
include::../examples/the_api/bind_native_function/bind_native_function_return_zs_int.cpp[]
----
...
[source,txt]
----
include::../examples/the_api/bind_native_function/bind_native_function_return_zs_int_out.txt[]
----
...
[source,c++]
----
include::../examples/the_api/bind_native_function/bind_native_function_return_zs_float.cpp[]
----
...
[source,txt]
----
include::../examples/the_api/bind_native_function/bind_native_function_return_zs_float_out.txt[]
----
...
[source,c++]
----
include::../examples/the_api/bind_native_function/bind_native_function_return_const_char.cpp[]
----
...
[source,txt]
----
include::../examples/the_api/bind_native_function/bind_native_function_return_const_char_out.txt[]
----
...
[source,c++]
----
include::../examples/the_api/bind_native_function/bind_native_function_return_zs_string.cpp[]
----
...
[source,txt]
----
include::../examples/the_api/bind_native_function/bind_native_function_return_zs_string_out.txt[]
----
...
[source,c++]
----
include::../examples/the_api/bind_native_function/bind_native_function_return_string_script_object.cpp[]
----
...
[source,txt]
----
include::../examples/the_api/bind_native_function/bind_native_function_return_string_script_object_out.txt[]
----
...
[source,c++]
----
include::../examples/the_api/bind_native_function/bind_native_function_return_array_script_object.cpp[]
----
...
[source,txt]
----
include::../examples/the_api/bind_native_function/bind_native_function_return_array_script_object_out.txt[]
----
...
[source,c++]
----
include::../examples/the_api/bind_native_function/bind_native_function_return_object_script_object.cpp[]
----
...
[source,txt]
----
include::../examples/the_api/bind_native_function/bind_native_function_return_object_script_object_out.txt[]
----
...
[source,c++]
----
include::../examples/the_api/bind_native_function/bind_native_function_return_class_script_object.cpp[]
----
...
[source,txt]
----
include::../examples/the_api/bind_native_function/bind_native_function_return_class_script_object_out.txt[]
----
...
[source,c++]
----
include::../examples/the_api/bind_native_function/bind_native_function_param_bool.cpp[]
----
...
[source,txt]
----
include::../examples/the_api/bind_native_function/bind_native_function_param_bool_out.txt[]
----
...
[source,c++]
----
include::../examples/the_api/bind_native_function/bind_native_function_param_zs_int.cpp[]
----
...
[source,txt]
----
include::../examples/the_api/bind_native_function/bind_native_function_param_zs_int_out.txt[]
----
...
[source,c++]
----
include::../examples/the_api/bind_native_function/bind_native_function_param_zs_float.cpp[]
----
...
[source,txt]
----
include::../examples/the_api/bind_native_function/bind_native_function_param_zs_float_out.txt[]
----
...
[source,c++]
----
include::../examples/the_api/bind_native_function/bind_native_function_param_const_char.cpp[]
----
...
[source,txt]
----
include::../examples/the_api/bind_native_function/bind_native_function_param_const_char_out.txt[]
----
...
[source,c++]
----
include::../examples/the_api/bind_native_function/bind_native_function_param_zs_string.cpp[]
----
...
[source,txt]
----
include::../examples/the_api/bind_native_function/bind_native_function_param_zs_string_out.txt[]
----
...
[source,c++]
----
include::../examples/the_api/bind_native_function/bind_native_function_param_string_script_object.cpp[]
----
...
[source,txt]
----
include::../examples/the_api/bind_native_function/bind_native_function_param_string_script_object_out.txt[]
----
...
[source,c++]
----
include::../examples/the_api/bind_native_function/bind_native_function_param_array_script_object.cpp[]
----
...
[source,txt]
----
include::../examples/the_api/bind_native_function/bind_native_function_param_array_script_object_out.txt[]
----
...
[source,c++]
----
include::../examples/the_api/bind_native_function/bind_native_function_param_object_script_object.cpp[]
----
...
[source,txt]
----
include::../examples/the_api/bind_native_function/bind_native_function_param_object_script_object_out.txt[]
----
...
[source,c++]
----
include::../examples/the_api/bind_native_function/bind_native_function_param_custom_type_object.cpp[]
----
...
[source,txt]
----
include::../examples/the_api/bind_native_function/bind_native_function_param_custom_type_object_out.txt[]
----
...
When a script function is evaluated through `ZetScript::eval` or  `ZetScript::evalFile`, it can bind that script function through _ZetScript::bindFunction_ that defines a function signature with types defined in one of <<built-in types>> or other binded type by template and the name of script function by parameter.
...
Note that a difference with `ZetScript::bindFunction` `ZetScript::bindScriptFunction` doesn't needs to have _ZetScript *_ defined as first parameter.
...
A script function that returns a _boolean_ value it must bind with a function signature that returns _bool_.
