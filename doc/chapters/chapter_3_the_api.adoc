...
The built-in types for the interface native to script side or viceversa are the following, 
...
This section will explain the how to define and bind native functions (functions in the C++ side) to be callable from script side.
...
Defining _bool_ return type it defines that the function will return a boolean value
...
Defining _zs_int_ return type it defines that the function will return a integer value
...
Defining _zs_float_ return type it defines that the function will return a float value
...
ZetScript can return a string by these types,

- _const char *_ type
- _zs_string_ type
- _StringScriptObject *_ type 

====== const char *

Defining _const char *_ return type it defines that the function will return a string as _const char *_ value
...
Defining _zs_string_ as type of return it defines a function that returns a string as _zs_string_ value
...
Defining _StringScriptObject *_ return type it defines that the function will return string as a pointer of _String_ script object. The creation of _StringScriptObject_ it's done with usign _ZetScript_ context.
...
Defining _ArrayScriptObject *_ return type it defines that the function will return a pointer of _Array_ script object. The creation of _ArrayScriptObject_ it's done through _ZetScript::newStringScriptObject_ usign _ZetScript_ context.
...
Defining _ObjectScriptObject *_ return type it defines that the function will return a pointer of _Object_ script object. The creation of _ObjectScriptObject_ it's done through _ZetScript::newArrayScriptObject_ usign _ZetScript_ context.
...
Defining _ClassScriptObject *_ return type it defines that the function will return a pointer of _Class_ script object. The creation of _ClassScriptObject_ it's done through _ZetScript::newClassScriptObject_ usign _ZetScript_ context. The creation _ClassScriptObject_ it needs to of To to bind a C/C++ type (see <<bind types>> section) 
...
A native function defined as script interface always has to define a `zetscript::ZetScript *` as first parameter and then it can define until 9 parameters as <<built-in types>> or custom types defined by the user. Possible types as arguments are the following,
...
To bind a function that requires a _boolean_ type as parameter it needs to define a _bool_ pointer (i.e _bool *_ )
...
To bind a function that requires a _integer_ type as parameter it needs to define a _zs_int_ or _zs_int_ pointer (i.e _zs_int *_ )
...
To bind a function that requires a _float_ type as parameter it needs to define a _zs_float_ pointer (i.e _zs_float *_ )
...
To bind a function that requires a _string_ type as parameter it can be defined by the following types:
...
To bind a function that requires a _string_ type as parameter it can be defined a _const char_ pointer (i.e _const char *_ )
...
To bind a function that requires a _string_ type as parameter it can be defined a _zs_string_ pointer (i.e _zs_string *_ )
...
===== String (StringScriptObject *)

To bind a function that requires a _string_ type as parameter it can be defined a _StringScriptObject_ pointer (i.e _StringScriptObject *_ )
...
To bind a function that requires a _array_ script object type as parameter it needs to define a _ArrayScriptObject_ pointer (i.e _ArrayScriptObject *_ )
...
To bind a function that requires a _object_ script object type as parameter it needs to define a _ObjectScriptObject_ pointer (i.e _ObjectScriptObject *_ )
...
To bind a function that requires a _custom type_ object type as parameter it has to binfneeds to be binded before _ObjectScriptObject_ pointer (i.e _ObjectScriptObject *_ )
