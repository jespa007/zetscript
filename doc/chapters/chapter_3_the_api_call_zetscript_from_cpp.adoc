...
===== Return instanced script class

In similar manner, to bind a ZetScript function that returns a *xref:chapter_2_the_language_data_types.adoc#_script_class[ScriptClass]* it must specify *ObjectScriptObject &ast;* return type on its function signature.
