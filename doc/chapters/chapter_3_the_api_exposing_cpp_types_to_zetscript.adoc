...
[source,javascript]
----
void RegisteredType_postdec(ZetScript *_zs, RegisteredType *_this);
----
...
The following code defines a function as a _postdec_ operation by decrementing the value of current instance,
...
The following code defines a function as a _preinc_ operation by incrementing the value of current instance,
...
[source,javascript]
----
void RegisteredType_predec(ZetScript *_zs, RegisteredType *_this);
----
...
The following code defines a function as a _predec_ operation by decrementing the value of current instance,
...
bool RegisteredType_postinc(zetscript::ZetScript *_zs, Data *_this, zs_float *_value);
...
The following code defines a function as a _in_ operation by searching in a number in the vector of current instance,
