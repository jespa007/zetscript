...
To no instantible type is done simple by calling *ZetScript::registerType* with type as template and the name that will be referenced in the script.
...
The following code shows an example of a registering non instantiable type,
