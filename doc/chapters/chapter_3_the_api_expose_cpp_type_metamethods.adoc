...
ZetScript API can register static or member metamethods in aim to define operators as we could see in *xref:chapter_2_the_language_class.adoc#&lowbar;metamethods[ZetScript class metamethods]*
