...
ZetScript API can register static or member metamethods in aim to define operators as we could see in *xref:chapters/chapter_2_the_language_class.adoc#&lowbar;metamethods[ZetScript class metamethods]*
...
The following code defines two functions performs an assignment from *xref:chapters/chapter_2_the_language_data_types.adoc#&lowbar;float[Float]* value or _Number_ object respectively,
...
Return new type wrapped in *xref:chapters/chapter_4_annex_api_types.adoc#_classscriptobject[ClassScripObject]* with the value before perform post increment operation
...
Return new type wrapped in *xref:chapters/chapter_4_annex_api_types.adoc#_classscriptobject[ClassScripObject]* with the value before perform post decrement operation
...
Return new type wrapped in *xref:chapters/chapter_4_annex_api_types.adoc#_classscriptobject[ClassScripObject]* with the value after perform post increment operation
