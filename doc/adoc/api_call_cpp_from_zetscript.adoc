...
To register a C function that returns a xref:language_data_types.adoc#lowbar;string[String] it can specify _zs_string_ as return type.

*Example*

[source,cpp]
----
include::../examples/api/register_function/register_function_return_zs_string.cpp[]
----
...
[source,txt]
----
include::../examples/api/register_function/register_function_return_zs_string_out.txt[]
----
...
To register a C function that returns a xref:api_expose_cpp_types#_register_type[registered type] it must specify _ClassScriptObject &#42;_ as return type. To instantiate _ClassScriptObject &#42;_  is done through _ZetScript::newClassScriptObject_ using ZetScript context and the registered class instantiated.
...
To register a C function that accepts a xref:language_data_types.adoc#_string[String] it can specify _const char *_ , _zs_string *_  or _StringScriptObject *_ as a parameter type,

*Example*

[source,cpp]
----
include::../examples/api/register_function/register_function_param_zs_string.cpp[]
----
...
[source,txt]
----
include::../examples/api/register_function/register_function_param_zs_string_out.txt[]
----
...
The following example it registers function _paramScriptFunction_ that accepts a xref:language_data_types.adoc#lowbar;function[Function] as parameter. Later, it evaluates an script that calls _paramScriptFunction_ passing anonymous function. In the calling function _paramScriptFunction_ it binds the anonymous function and it calls.
