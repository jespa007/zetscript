...
ZetScript API can register static and member metamethods in aim to define operators as we could see in _xref:chapter_2_the_language_class.adoc#_metamethods[chapter 2 class metamethods]_.
