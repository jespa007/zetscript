...
- __zs_ : ZetScript context
- __this_ : The current instance
- __value_ : A value to be set. Its type can be a pointer of one defined in  xref:chapter_3_the_api_types#_types[built-in types] or a pointer of other xref:chapter_3_the_api_expose_cpp_types#_register_a_type[registered type].
...
- __zs_ : ZetScript context
- __this_ : The current instance
- __value_ : Value or variable as right operand. Its type can be a pointer of one defined in xref:chapter_3_the_api_types#_types[built-in types] or a pointer of other xref:chapter_3_the_api_expose_cpp_types#_register_a_type[registered type].
