...
the ZetScript API allows to register static and member metamethods in aim to define operators as we could see in _xref:chapter_2_the_language_class.adoc#_metamethods[chapter 2 class metamethods]_.
...
- __zs_ : ZetScript context
- __this_ : The current instance
- __value_ : A value to be set. Its type can be a pointer of one defined in  xref:chapter_3_the_api_built_in_types#_built_in_types[built-in types] or a pointer of other xref:chapter_3_the_api_expose_cpp_types#_register_a_type[registered type].
...
- __zs_ : ZetScript context
- __this_ : The current instance
- __value_ : Value or variable as right operand. Its type can be a pointer of one defined in xref:chapter_3_the_api_built_in_types#_built_in_types[built-in types] or a pointer of other xref:chapter_3_the_api_expose_cpp_types#_register_a_type[registered type].
