...
_ScriptEngine::bindScriptFunction_ binds ZetScript function from its name or ZetScript function type to be invokable from C++.
...
[.underline]#Parameters#
 ...
 - _&#95;script_function_name_: the the ZetScript function name to bind
 - _&#95;member_function_script_object_: the ZetScript function member function to bind
 - _&#95;object_: the ZetScript object of the function member to bind
 - _&#95;script_function_: the ZetScript script function to bind 
...
[source,txt]
----
include::../examples/api/types/script_engine_extends.txt[]
----
...
[source,txt]
----
include::../examples/api/types/script_engine_register_constant.txt[]
----
...
[source,txt]
----
include::../examples/api/types/script_engine_register_const_member_property.txt[]
----
...
[source,txt]
----
include::../examples/api/types/script_engine_register_constructor.txt[]
----
...
===== ScriptEngine::registerScriptType()

Registers a C++ type to be exposed in ZetScript. A registered types can be static (not instantiable) or instantiable if the create and destroy functions are or not defined.

*Syntax*
[source,cpp]
----
ScriptType * registerScriptType<T>(const String & _script_type_name, F _new_c_function=NULL, F _delete_c_function=NULL);
----
...
[source,txt]
----
include::../examples/api/types/script_engine_register_script_type_not_instantiable.txt[]
----
...
[source,txt]
----
include::../examples/api/types/script_engin_save_state_out.txt[]
----
...
template<typename _C>
		_C 				stackElementTo(StackElement * _stack_element);
----

[.underline]#Template parameters# 

- _C_ : The type to be converted Class can be the following,

include::api_stack_element_to_return.adoc

[.underline]#Parameters# 

- _stack_element: Stack element to convert
...
[source,txt]
----
include::../examples/api/types/script_engine_stack_element_to_out.txt[]
----