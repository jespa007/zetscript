...
The only way to operate with a 'Number' object non instantiable is by a returning a reference of object 'Number' from registered C function as it shows in the following example,
