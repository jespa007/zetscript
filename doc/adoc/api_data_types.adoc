...
|TYPE_ID_OBJECT_OBJECT
|Tells that the object is an instance of  ObjectObject
...
The ObjectObject constructor creates a new object script object. ObjectObject constructor needs a ZetScript context.
...
[source,cpp]
----
void ObjectObject::set(int _key, _T _element)
----
...
====== ObjectObject::elementInstanceOf()
