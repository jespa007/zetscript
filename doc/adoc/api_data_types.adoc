...
- _function : C function to register.
...
std::function<F> bindScriptFunction(const String & _function_access, const char *_file="", int _line=-1);

std::function<F> bindScriptFunction(MemberFunctionObject *_sf, const char *_file="", int _line=-1);


std::function<F> bindScriptFunction(ScriptFunction *_sf, Object *_calling_object, const char *_file="", int _line=-1);
