...
===== ScriptEngine::registerConstant[ScriptType]()

Registers a constant script type value.

*Syntax*

[source,cpp]
----
void registerConstantInteger(const String & _const_name, zs_int _i_value, const char *registered_file="", short registered_line=-1);

void registerConstantFloat(const String & _const_name, zs_float _f_value, const char *registered_file="", short registered_line=-1);

void registerConstantBoolean(const String & _const_name, bool _b_value, const char *registered_file="", short registered_line=-1);

void registerConstantString(const String & _const_name, const String & _str_value, const char *registered_file="", short registered_line=-1);
...
- ___b_value__	: Constant as Boolean value
- ___i_value__	: Constant as Integer value
- ___f_value__	: Constant as Float value
- ___s_value__	: Constant as String value
