...
The ArrayScriptObject constructor creates a new array script object. ArrayScriptObject constructor needs a ScriptEngine instance.
...
The ObjectScriptObject constructor creates a new object script object. ObjectScriptObject constructor needs a ScriptEngine instance.
...
_ScriptEngine::bindScriptFunction_ it binds ZetScript function by the C&#43;&#43; function signature and the symbol name or _Function_ object.
