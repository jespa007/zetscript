...
|SCRIPT_TYPE_PROPERTY_C_OBJECT_REF		
...
- script_type_id: The script type representated by the instance of script object. ZetScript it register primitive objects as which script_type_ids matches with the following,
...
|SCRIPT_TYPE_ID_SCRIPT_OBJECT_STRING
|Tells that the object is an instance of StringScriptObject

|SCRIPT_TYPE_ID_SCRIPT_OBJECT_ARRAY
|Tells that the object is an instance of  ScriptObjectArray

|SCRIPT_TYPE_ID_SCRIPT_OBJECT_OBJECT
|Tells that the object is an instance of  ObjectScriptObject

|SCRIPT_TYPE_ID_SCRIPT_OBJECT_CLASS
|Tells that the object is an instance of  ClassScriptObject
|====
