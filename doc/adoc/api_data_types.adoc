...
[source,cpp]
----
include::../examples/api/types/zs_string_example.cpp[]
----
...
[source,cpp]
----
include::../examples/api/types/zs_string_example_out.txt[]
----
...
[source,cpp]
----
include::../examples/api/types/zs_vector_example.cpp[]
----
...
[source,cpp]
----
include::../examples/api/types/zs_vector_example_out.txt[]
----
...
_StringScriptObject_ it defines a string script object. It uses zetscript context in order to be instanced in specific C function callable from ZetScript (see section xref:api_call_cpp_from_zetscript.adoc#_call_c_from_zetscript[Call C++ from ZetScript] section for more information).

===== Member functions

====== StringScriptObject::StringScriptObject()

Creates new string script object.
...
_ArrayScriptObject_ it defines a array script object. It uses zetscript context in order to be instanced in specific C function callable from ZetScript (see section xref:api_call_cpp_from_zetscript.adoc#_call_c_from_zetscript[Call C++ from ZetScript] section for more information).

===== Member functions

====== ArrayScriptObject::ArrayScriptObject()

Creates new array script object. This function is used when it needs to return a string script object from the C function registered (see   section xref:api_call_cpp_from_zetscript.adoc#_call_c_from_zetscript[Call C++ from ZetScript] section for more information).
...
- _&#95;T_ : ZetScript api types as bool, zs_int, zs_float, const char &#42; zs_string &#42;, ScriptScriptObject &#42;, ArrayScriptObject &#42;,ObjectScriptObject &#42; or ClassScriptObject &#42; that wraps a registered type.
...
- _&#95;T_ : ZetScript api types as bool, zs_int, zs_float, const char &#42; zs_string &#42;, ScriptScriptObject &#42;, ArrayScriptObject &#42;,ObjectScriptObject &#42; or a pointer of a registered type.
...
====== ArrayScriptObject::elementExtendsFrom()

Says whether the element at a position extends from builtin or registered type.

*Syntax*

[source,cpp]
----
bool 	elementExtendsFrom<_T>(int _pos);
----

[.underline]#Template#

- _&#95;T_ : Data type as bool, zs_int, zs_float, const char &#42; zs_string &#42;, ScriptScriptObject &#42;, ArrayScriptObject &#42;,ObjectScriptObject &#42; or a pointer of a registered type.
...
[source,cpp]
----
include::../examples/api/types/array_script_object_element_extends_from.cpp[]
----
...
[source,txt]
----
include::../examples/api/types/array_script_object_element_extends_from_out.txt[]
----
