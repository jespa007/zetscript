...
_StringScriptObject_ defines a string script object which instance can live in C++ or ZetScript.

===== Constructor

====== StringScriptObject::StringScriptObject()

Constructor of string script object.  It uses zetscript context in order to be instanced.
...
_ArrayScriptObject_ it defines a array script object which instance can live in C++ or ZetScript.

===== Contructor

====== ArrayScriptObject::ArrayScriptObject()

Constructor of array script object. It needs ZetScript context in order to be instanced.
