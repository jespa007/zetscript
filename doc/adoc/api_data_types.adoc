...
ScriptType is an type managed by ScriptEngine that defines a builtin or registered script type. ScriptType has the following fields.
...
_ScriptObject_ defines a the parent class of any object in TypeScript. This type is usually used internally by ScriptEngine. The _ScriptObject_ type has the following fields:
...
It prints the generated byte code of compiled script/s. The output console prints a header and a list of intructions

*Header*

The description of the header printed is the following,
...
The description per instruction with the following columns,
...
The list of byte code it can print is the following,
...
[source,txt]
----
include::../examples/api/eval/script_engine_print_generated_code_out.txt[]
----
...
[source,txt]
----
include::../examples/api/eval/script_engine_register_constant.txt[]
----
...
[source,cpp]
----
include::../examples/api/types/script_engine_register_type.cpp[]
----
...
[source,txt]
----
include::../examples/api/eval/script_engine_register_type.txt[]
----
...
[source,txt]
----
include::../examples/api/eval/script_engine_extends.txt[]
----
...
[source,txt]
----
include::../examples/api/eval/script_engine_register_constructor.txt[]
----
...
[source,txt]
----
include::../examples/api/eval/script_engine_register_member_function.txt[]
----
...
[source,txt]
----
include::../examples/api/eval/script_engine_register_const_member_property.txt[]
----
...
[source,txt]
----
include::../examples/api/eval/script_engine_register_member_property_metamethod_out.txt[]
----
...
[source,txt]
----
include::../examples/api/eval/script_engine_register_static_member_function_out.txt[]
----
