...
[.underline]#Parameters#
 ...
 - _ParamTypeX_: It can be a pointer of xref:chapter_3_the_api_built_in_types#_built_in_types[built-in type] or a pointer of xref:chapter_3_the_api_expose_cpp_types#_register_a_type[registered type].
...
To bind a ZetScript function that returns an instance of _xref:chapter_2_the_language_data_types.adoc#_class[Class]_ type object it can specify _ObjectScriptObject &#42;_ or _ClassScriptObject &#42;_ return type on its function signature.
...
To bind a ZetScript function that accepts a _xref:chapter_2_the_language_data_types.adoc#_boolean[Boolean]_ it must specify _bool &#42;_ as parameter type on its function signature.
...
To bind a ZetScript function that accepts a _xref:chapter_2_the_language_data_types.adoc#_integer[Integer]_ it must specify _zs_int_ or _zs_int &#42;_ as parameter type on its function signature.
...
To bind a ZetScript function that accepts a _xref:chapter_2_the_language_data_types.adoc#_float[Float]_ it must specify or _zs_float &#42;_ as parameter type on its function signature.
...
To bind a ZetScript function that accepts a _xref:chapter_2_the_language_data_types.adoc#_string[String]_ it can specify _const char &#42;_ as parameter type on its function signature.
...
To bind a ZetScript function that accepts a _xref:chapter_2_the_language_data_types.adoc#_string[String]_ it can specify _zs_string &#42;_ as parameter type on its function signature.
...
To bind a ZetScript function that accepts a _xref:chapter_3_the_api_expose_cpp_types#&#x5f;register_type[registered type]_ as a parameter, it must specify native pointer type as parameter type on its function signature.
