...
[.underline]#Parameters#
 ...
 - _ReturnType_: It can be void, a xref:chapter_3_the_api_types#_types[built-in type] or a xref:chapter_3_the_api_expose_cpp_types#_register_a_type[registered type].
 - _ParamTypeX_: It can be a pointer of xref:chapter_3_the_api_types#_types[built-in type] or a pointer of xref:chapter_3_the_api_expose_cpp_types#_register_a_type[registered type].
