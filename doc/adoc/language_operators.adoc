...
ScriptEngine supports the following operator types,
...
Assignment operators assign values to ScriptEngine variables. The assigment operators are the following,
...
[source,javascript]
----
include::../examples/scripts/type/type_instanceof.zs[]
----
...
[source,text]
----
include::../examples/scripts/type/type_instanceof_out.txt[]
----
...
[source,javascript]
----
include::../examples/scripts/type/type_typeof.zs[]
----
...
[source,text]
----
include::../examples/scripts/type/type_typeof_out.txt[]
----
