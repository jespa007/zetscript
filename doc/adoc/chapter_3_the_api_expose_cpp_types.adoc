...
- __arg1_ .. __arg8_: Arguments which is a pointer of xref:chapter_3_the_api_types#_types[built-in type] or a pointer of xref:chapter_3_the_api_expose_cpp_types#_register_a_type[registered type].
...
- __zs_ : ZetScript context
- __this_: The current instance
- __arg1_ .. __arg8_: Arguments which types are pointers of xref:chapter_3_the_api_types#_types[built-in types] or a pointer of a registered type.
...
As parameters, the function must always include _ZetScript *_ as the FIRST parameter and the SECOND till the NINETH parameter as a pointer of  xref:chapter_3_the_api_types#_types[built-in type] or a pointer of a xref:chapter_3_the_api_expose_cpp_types#_register_a_type[registered type]. 
...
- __zs_ : ZetScript context
- __arg1_ .. __arg9_: Arguments which types are pointers of xref:chapter_3_the_api_types#_types[built-in types] or a pointer of a registered type.
