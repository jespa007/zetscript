...
In this chapter will see how to to register C/C++ types, function members, metamethods and properties in order to be exposed in ZetScript.

// TODO: Explain base source Number.cpp and functions related that it be show along this chapter to see the examples

Along the examples will define and register functions to operate with the following class 'Number',
...
Let's define __NumberZs_new__ and __NumberZs_delete__ functions that creates and destroys a __Number__ type instantiation respectively,
