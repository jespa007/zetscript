...
[source,cpp]
----
void RegisteredType_constructor(ScriptEngine *_script_engine, RegisteredType *_this, ParamType *_arg1, ..., ParamType *_arg8 ){
	....
}
----
...
[source,cpp]
----
ReturnType RegisteredType_staticMemberFunction(ScriptEngine *_script_engine, ParamType *_arg1, ..., ParamType *_arg9 ){
	....
}
----
