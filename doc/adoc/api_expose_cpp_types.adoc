...
[source,cpp]
----
Type * registerType<_Type>(const String & _class_name, RegisteredType * (*_new_native_instance)(ScriptEngine *_zs), void (*_delete_native_instance)(ScriptEngine *_zs, RegisteredType * _this));
----
...
[source,cpp]
----
RegsiteredType * RegisteredType_new(ScriptEngine *_zs);
----
...
[source,cpp]
----
void RegisteredType_delete(ScriptEngine *_zs, RegisteredType *_this);
----
...
[source,cpp]
----
void RegisteredType_constructor(ScriptEngine *_zs, RegisteredType *_this, ParamType *_arg1, ..., ParamType *_arg8 ){
	....
}
----
...
void NumberZs_constructor(ScriptEngine *_zs,Number *_this,zs_float *_value){
	_this->value=*_value;
}

void NumberZs_constructor(ScriptEngine *_zs,Number *_this,Number *_value){
...
[source,cpp]
----
ReturnType RegisteredType_memberFunction(ScriptEngine *_zs, _RegisteredType *_this, ParamType *_arg1, ..., ParamType *_arg8 ){
	....
}
----
...
[source,cpp]
----
ReturnType RegisteredType_staticMemberFunction(ScriptEngine *_zs, ParamType *_arg1, ..., ParamType *_arg9 ){
	....
}
----
