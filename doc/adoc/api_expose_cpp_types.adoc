...
[source,cpp]
----
Type * registerType<_Type>(const String & _class_name, RegisteredType * (*_new_native_instance)(ZetScript *_zs), void (*_delete_native_instance)(ZetScript *_zs, RegisteredType * _this));
----
...
As parameters, the function must always include _ZetScript *_ as the FIRST parameter,the current instance as the SECOND parameter and the THIRD till the EIGHTH parameter as a pointer of  xref:api_types#_types[primitive type] or a pointer of a xref:api_expose_cpp_types#_register_a_type[registered type]. 
...
As a return, the function it can return _void_, _bool_, _zs_int_, _zs_float_, _String_, a new instance of _StringObject_, _ArrayObject_, DictionaryObject or new instance/reference of a registered type.
...
- _RegisteredType_: The registered type
- _ReturnType_: Return type can be void, bool, zs_int,zs_float, String,  a new instance of _StringObject_, _ArrayObject_, DictionaryObject or new instance/reference of a registered type
...
As parameters, the function must always include _ZetScript *_ as the FIRST parameter and the SECOND till the NINETH parameter as a pointer of  xref:api_types#_types[primitive type] or a pointer of a xref:api_expose_cpp_types#_register_a_type[registered type]. 
...
- _RegisteredType_: The registered type
- _ReturnType_: Return type can be _void_, _bool_, _zs_int_, _zs_float_, _String_, a new instance of _StringObject_, _ArrayObject_, DictionaryObject or new instance/reference of a registered type.
