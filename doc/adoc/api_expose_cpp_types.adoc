...
As a return, the function it can return _void_, _bool_, _zs_int_, _zs_float_, _String_, a new instance of _StringObject_, _ArrayObject_, ObjectObject or new instance/reference of a registered type.
...
- _RegisteredType_: The registered type
- _ReturnType_: Return type can be void, bool, zs_int,zs_float, String,  a new instance of _StringObject_, _ArrayObject_, ObjectObject or new instance/reference of a registered type
...
- _RegisteredType_: The registered type
- _ReturnType_: Return type can be _void_, _bool_, _zs_int_, _zs_float_, _String_, a new instance of _StringObject_, _ArrayObject_, ObjectObject or new instance/reference of a registered type.
