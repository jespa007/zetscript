...
In this chapter will see how to to register C/C++ types, function members, metamethods and properties in order to be exposed in __ZetScript__ through examples.
