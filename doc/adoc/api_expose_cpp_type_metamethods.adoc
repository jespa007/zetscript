...
the ZetScript API allows to register static and member metamethods in aim to define operators as we could see in xref:language_class.adoc#_metamethods[chapter 2 class metamethods].
...
[source,cpp]
----
String RegisteredType_tostring(ZetScript * _zs, RegisteredType *_this);
----
...
Next, the function _NumberZs_tostring_ is registered as member metamethod __tostring_ through _ZetScript::registerMemberFunction_,
...
- __zs_ : ZetScript context
- __this_ : The current instance
- __value_ : A value to be set. Its type can be a pointer of one defined in  xref:api_types#_types[built-in types] or a pointer of other xref:api_expose_cpp_types#_register_a_type[registered type].
...
Next, each function _NumberZs_set_ function is registered as member metamethod __set_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_addset_ is registered as member metamethod __addset_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_subset_ is registered as member metamethod __subset_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_mulset_ is registered as member metamethod __mulset_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_divset_ is registered as member metamethod __divset_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_modset_ is registered as member metamethod __modset_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_andset_ is registered as member metamethod __andset_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_orset_ is registered as member metamethod __orset_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_xorset_ is registered as member metamethod __xorset_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_shrset_ is registered as member metamethod __shrset_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_shlset_ is registered as member metamethod __shlset_ through _ZetScript::registerMemberFunction_,
...
Next, the function _NumberZs_not_ is registered as member metamethod __not_ through _ZetScript::registerMemberFunction_,
...
[source,javascript]
----
ClassObject *RegisteredType_neg(ZetScript *_zs, RegisteredType *_this);
----
...
Next, the function _NumberZs_neg_ is registered as member metamethod __neg_ through _ZetScript::registerMemberFunction_,
...
[source,javascript]
----
ClassObject * RegisteredType_postinc(ZetScript *_zs, RegisteredType *_this);
----
...
Next, the function _NumberZs_postinc_ is registered as member metamethod __postinc_ through _ZetScript::registerMemberFunction_,
...
[source,javascript]
----
ClassObject * RegisteredType_postdec(ZetScript *_zs, RegisteredType *_this);
----
...
Next, the function _NumberZs_postdec_ is registered as member metamethod __postdec_ through _ZetScript::registerMemberFunction_,
...
[source,javascript]
----
ClassObject *RegisteredType_preinc(ZetScript *_zs, RegisteredType *_this);
----
...
Next, the function _NumberZs_preinc_ is registered as member metamethod __preinc_ through _ZetScript::registerMemberFunction_,
...
[source,javascript]
----
ClassObject * RegisteredType_predec(ZetScript *_zs, RegisteredType *_this);
----
...
Next, the function _NumberZs_predec_ is registered as member metamethod __predec_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_equ_ is registered as member metamethod __equ_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_nequ_ is registered as member metamethod __nequ_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_lt_ is registered as member metamethod __lt__ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_lte_ is registered as member metamethod __lte_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_gt_ is registered as member metamethod __gt__ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_gte_ is registered as member metamethod __gte_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_add_ is registered as member metamethod __add_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_sub_ is registered as member metamethod __sub_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_mul_ is registered as member metamethod __mul_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_div_ is registered as member metamethod __div_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_mod_ is registered as member metamethod __mod_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_and_ is registered as member metamethod __AND_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_or_ is registered as member metamethod __OR_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_xor_ is registered as member metamethod __XOR_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_shl_ is registered as member metamethod __shl_ through _ZetScript::registerMemberFunction_,
...
Next, each function _NumberZs_shr_ is registered as member metamethod __shr_ through _ZetScript::registerMemberFunction_,
