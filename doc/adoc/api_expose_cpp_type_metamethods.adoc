...
[source,cpp]
----
String RegisteredType_tostring(ScriptEngine * _zs, RegisteredType *_this);
----
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
...
[source,cpp]
----
void RegisteredType_set(ScriptEngine * _zs, RegisteredType *_this, ParamType * _value);
----
...
[source,cpp]
----
void RegisteredType_addset(ScriptEngine *_zs, RegisteredType *_this,ParamType *_value);
----
...
void NumberZs_addset(ScriptEngine *_zs, Number *_this,zs_float *_n){
	_this->value+=*_n;
}

void NumberZs_addset(ScriptEngine *_zs, Number *_this,Number *_n){
	_this->value+=_n->value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
	...
	//...
	_zs->registerMemberFunction<Number>("_addset",static_cast<void (*)(ScriptEngine *_zs,Number *,zs_float *)>(&NumberZs_addset));

	_zs->registerMemberFunction<Number>("_addset",static_cast<void (*)(ScriptEngine *_zs,Number *,Number * )>(&NumberZs_addset));
	//...
...
[source,cpp]
----
void RegisteredType_subset(ScriptEngine *_zs, RegisteredType *_this,ParamType *_value);
----
...
void NumberZs_subset(ScriptEngine *_zs, Number *_this,zs_float *_n){
	_this->value-=*_n;
}

void NumberZs_subset(ScriptEngine *_zs, Number *_this,Number *_n){
	_this->value-=_n->value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
	//...
	_zs->registerMemberFunction<Number>("_subset",static_cast<void (*)(ScriptEngine *_zs,Number *,zs_float *)>(&NumberZs_subset));

	_zs->registerMemberFunction<Number>("_subset",static_cast<void (*)(ScriptEngine *_zs,Number *,Number * )>(&NumberZs_subset));
	//...
}
----
...
[source,cpp]
----
void RegisteredType_mulset(ScriptEngine *_zs, RegisteredType *_this,ParamType *_value);
----
...
void NumberZs_mulset(ScriptEngine *_zs, Number *_this,zs_float *_n){
	_this->value-=*_n;
}

void NumberZs_mulset(ScriptEngine *_zs, Number *_this,Number *_n){
	_this->value-=_n->value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
	//...
	_zs->registerMemberFunction<Number>("_mulset",static_cast<void (*)(ScriptEngine *_zs,Number *,zs_float *)>(&NumberZs_mulset));

	_zs->registerMemberFunction<Number>("_mulset",static_cast<void (*)(ScriptEngine *_zs,Number *,Number * )>(&NumberZs_mulset));
	//...
}
----
...
[source,cpp]
----
void RegisteredType_divset(ScriptEngine *_zs, RegisteredType *_this,ParamType *_value);
----
...
void NumberZs_divset(ScriptEngine *_zs, Number *_this,zs_float *_n){
	_this->value-=*_n;
}

void NumberZs_divset(ScriptEngine *_zs, Number *_this,Number *_n){
	_this->value-=_n->value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
	...
	//...
	_zs->registerMemberFunction<Number>("_divset",static_cast<void (*)(ScriptEngine *_zs,Number *,zs_float *)>(&NumberZs_divset));

	_zs->registerMemberFunction<Number>("_divset",static_cast<void (*)(ScriptEngine *_zs,Number *,Number * )>(&NumberZs_divset));
	//...
}
----
...
[source,cpp]
----
void RegisteredType_modset(ScriptEngine *_zs, RegisteredType *_this,ParamType *_value);
----
...
void NumberZs_modset(ScriptEngine *_zs, Number *_this,zs_float *_n){
	_this->value-=*_n;
}

void NumberZs_modset(ScriptEngine *_zs, Number *_this,Number *_n){
	_this->value-=_n->value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
	...
	//...
	_zs->registerMemberFunction<Number>("_modset",static_cast<void (*)(ScriptEngine *_zs,Number *,zs_float *)>(&NumberZs_modset));

	_zs->registerMemberFunction<Number>("_modset",static_cast<void (*)(ScriptEngine *_zs,Number *,Number * )>(&NumberZs_modset));
	//...
...
[source,cpp]
----
void RegisteredType_andset(ScriptEngine *_zs, RegisteredType *_this,ParamType *_value);
----
...
void NumberZs_andset(ScriptEngine *_zs, Number *_this,zs_float *_n){
	_this->value-=*_n;
}

void NumberZs_andset(ScriptEngine *_zs, Number *_this,Number *_n){
	_this->value-=_n->value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
	...
	//...
	_zs->registerMemberFunction<Number>("_andset",static_cast<void (*)(ScriptEngine *_zs,Number *,zs_float *)>(&NumberZs_andset));

	_zs->registerMemberFunction<Number>("_andset",static_cast<void (*)(ScriptEngine *_zs,Number *,Number * )>(&NumberZs_andset));
	//...
...
[source,cpp]
----
void RegisteredType_orset(ScriptEngine *_zs, RegisteredType *_this,ParamType *_value);
----
...
void NumberZs_orset(ScriptEngine *_zs, Number *_this,zs_float *_n){
	_this->value-=*_n;
}

void NumberZs_orset(ScriptEngine *_zs, Number *_this,Number *_n){
	_this->value-=_n->value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
	...
	//...
	_zs->registerMemberFunction<Number>("_orset",static_cast<void (*)(ScriptEngine *_zs,Number *,zs_float *)>(&NumberZs_orset));

	_zs->registerMemberFunction<Number>("_orset",static_cast<void (*)(ScriptEngine *_zs,Number *,Number * )>(&NumberZs_orset));
	//...
...
[source,cpp]
----
void RegisteredType_xorset(ScriptEngine *_zs, RegisteredType *_this,ParamType *_value);
----
...
void NumberZs_xorset(ScriptEngine *_zs, Number *_this,zs_float *_n){
	_this->value-=*_n;
}

void NumberZs_xorset(ScriptEngine *_zs, Number *_this,Number *_n){
	_this->value-=_n->value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
	...
	//...
	_zs->registerMemberFunction<Number>("_xorset",static_cast<void (*)(ScriptEngine *_zs,Number *,zs_float *)>(&NumberZs_xorset));

	_zs->registerMemberFunction<Number>("_xorset",static_cast<void (*)(ScriptEngine *_zs,Number *,Number * )>(&NumberZs_xorset));
	//...
...
[source,cpp]
----
void RegisteredType_shrset(ScriptEngine *_zs, RegisteredType *_this,ParamType *_value);
----
...
void NumberZs_shrset(ScriptEngine *_zs, Number *_this,zs_float *_n){
	_this->value-=*_n;
}

void NumberZs_shrset(ScriptEngine *_zs, Number *_this,Number *_n){
	_this->value-=_n->value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
	...
	//...
	_zs->registerMemberFunction<Number>("_shrset",static_cast<void (*)(ScriptEngine *_zs,Number *,zs_float *)>(&NumberZs_shrset));

	_zs->registerMemberFunction<Number>("_shrset",static_cast<void (*)(ScriptEngine *_zs,Number *,Number * )>(&NumberZs_shrset));
	//...
...
[source,cpp]
----
void RegisteredType_shlset(ScriptEngine *_zs, RegisteredType *_this,ParamType *_value);
----
...
void NumberZs_shlset(ScriptEngine *_zs, Number *_this,zs_float *_n){
	_this->value-=*_n;
}

void NumberZs_shlset(ScriptEngine *_zs, Number *_this,Number *_n){
	_this->value-=_n->value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
	...
	//...
	_zs->registerMemberFunction<Number>("_shlset",static_cast<void (*)(ScriptEngine *_zs,Number *,zs_float *)>(&NumberZs_shlset));

	_zs->registerMemberFunction<Number>("_shlset",static_cast<void (*)(ScriptEngine *_zs,Number *,Number * )>(&NumberZs_shlset));
	//...
...
[source,javascript]
----
bool RegisteredType_not(ScriptEngine *_zs, RegisteredType *_this);
----
...
[source,javascript]
----
ClassObject *RegisteredType_neg(ScriptEngine *_zs, RegisteredType *_this);
----
...
Number * NumberZs_neg(ScriptEngine *_zs,Number *_this){
...
[source,javascript]
----
ClassObject * RegisteredType_postinc(ScriptEngine *_zs, RegisteredType *_this);
----
...
ClassObject *  NumberZs_postinc(ScriptEngine *_zs,Number *_this){
...
[source,javascript]
----
ClassObject * RegisteredType_postdec(ScriptEngine *_zs, RegisteredType *_this);
----
...
ClassObject * NumberZs_postdec(ScriptEngine *_zs,Number *_this){
	return _zs->newClassObject(new Number(_this->value--));
}
...
[source,javascript]
----
ClassObject *RegisteredType_preinc(ScriptEngine *_zs, RegisteredType *_this);
----
...
ClassObject * NumberZs_preinc(ScriptEngine *_zs,Number *_this){
	return _zs->newClassObject(new Number(++_this->value));
}
...
[source,javascript]
----
ClassObject * RegisteredType_predec(ScriptEngine *_zs, RegisteredType *_this);
----
...
ClassObject  *NumberZs_predec(ScriptEngine *_zs,Number *_this){
	return _zs->newClassObject(new Number(--_this->value));
}
...
bool RegisteredType_in(zetscript::ScriptEngine *_zs, Data *_this, zs_float *_value);
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
	...
	//...
	_zs->registerMemberConstructor<Number>(static_cast<void (*)(zetscript::ScriptEngine *_zs,Number *_this, zetscript::zs_float *_value)>(&NumberZs_set));

	_zs->registerMemberConstructor<Number>(static_cast<void (*)(zetscript::ScriptEngine *_zs,Number *_this, Number *_value)>(&NumberZs_set));
	//...
...
ClassObject * NumberZs_add(ScriptEngine *_zs,Number *_n1, Number *_n2){
	return _zs->newClassObject(new Number(_n1->value +_n2->value));
}

ClassObject * NumberZs_add(ScriptEngine *_zs,Number *_n1, zs_float *_n2){
	return _zs->newClassObject(new Number(_n1->value + *_n2));
}

ClassObject * NumberZs_add(ScriptEngine *_zs,zs_float *_n1, Number *_n2){
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
	...
	_zs->registerStaticMemberFunction<Number>("_add",static_cast<ClassObject * (*)(ScriptEngine *_zs,zs_float *,Number * )>(&NumberZs_add));
	_zs->registerStaticMemberFunction<Number>("_add",static_cast<ClassObject * (*)(ScriptEngine *_zs,Number *,zs_float *)>(&NumberZs_add));
	_zs->registerStaticMemberFunction<Number>("_add",static_cast<ClassObject * (*)(ScriptEngine *_zs,Number *,Number * )>(&NumberZs_add));
...
ClassObject * NumberZs_sub(ScriptEngine *_zs,Number *_n1, Number *_n2){
	return _zs->newClassObject(new Number(_n1->value +_n2->value));
}

ClassObject * NumberZs_sub(ScriptEngine *_zs,Number *_n1, zs_float *_n2){
	return _zs->newClassObject(new Number(_n1->value + *_n2));
}

ClassObject * NumberZs_sub(ScriptEngine *_zs,zs_float *_n1, Number *_n2){
	return _zs->newClassObject(new Number(*_n1 + _n2->value));
}
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
	...
	_zs->registerStaticMemberFunction<Number>("_sub",static_cast<ClassObject * (*)(ScriptEngine *_zs,zs_float *,Number * )>(&NumberZs_sub));
	_zs->registerStaticMemberFunction<Number>("_sub",static_cast<ClassObject * (*)(ScriptEngine *_zs,Number *,zs_float *)>(&NumberZs_sub));
	_zs->registerStaticMemberFunction<Number>("_sub",static_cast<ClassObject * (*)(ScriptEngine *_zs,Number *,Number * )>(&NumberZs_sub));
...
ClassObject * NumberZs_mul(ScriptEngine *_zs,Number *_n1, Number *_n2){
	return _zs->newClassObject(new Number(_n1->value * _n2->value));
}

ClassObject * NumberZs_mul(ScriptEngine *_zs,Number *_n1, zs_float *_n2){
	return _zs->newClassObject(new Number(_n1->value * (*_n2)));
}

ClassObject * NumberZs_mul(ScriptEngine *_zs,zs_float *_n1, Number *_n2){
	return _zs->newClassObject(new Number(*_n1 * _n2->value));
}
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
	//...
	_zs->registerStaticMemberFunction<Number>("_mul",static_cast<ClassObject * (*)(ScriptEngine *_zs,zs_float *,Number * )>(&NumberZs_mul));
	_zs->registerStaticMemberFunction<Number>("_mul",static_cast<ClassObject * (*)(ScriptEngine *_zs,Number *,zs_float *)>(&NumberZs_mul));
	_zs->registerStaticMemberFunction<Number>("_mul",static_cast<ClassObject * (*)(ScriptEngine *_zs,Number *,Number * )>(&NumberZs_mul));
	//...
}
----
...
ClassObject * NumberZs_div(ScriptEngine *_zs,Number *_n1, Number *_n2){
	return _zs->newClassObject(new Number(_n1->value / _n2->value));
}

ClassObject * NumberZs_div(ScriptEngine *_zs,Number *_n1, zs_float *_n2){
	return _zs->newClassObject(new Number(_n1->value / *_n2));
}

ClassObject * NumberZs_div(ScriptEngine *_zs,zs_float *_n1, Number *_n2){
	return _zs->newClassObject(new Number(*_n1 / _n2->value));
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
	...
	//...
	_zs->registerStaticMemberFunction<Number>("_div",static_cast<ClassObject * (*)(ScriptEngine *_zs,zs_float *,Number * )>(&NumberZs_div));
	_zs->registerStaticMemberFunction<Number>("_div",static_cast<ClassObject * (*)(ScriptEngine *_zs,Number *,zs_float *)>(&NumberZs_div));
	_zs->registerStaticMemberFunction<Number>("_div",static_cast<ClassObject * (*)(ScriptEngine *_zs,Number *,Number * )>(&NumberZs_div));
	//...
}
----
...
[source,cpp]
----
ClassObject * NumberZs_mod(ScriptEngine *_zs,Number *_n1, Number *_n2){
	return _zs->newClassObject(new Number(fmod(_n1->value,_n2->value)));
}

ClassObject * NumberZs_mod(ScriptEngine *_zs,Number *_n1, zs_float *_n2){
	return _zs->newClassObject(new Number(fmod(_n1->value, *_n2)));
}

ClassObject * NumberZs_mod(ScriptEngine *_zs,zs_float *_n1, Number *_n2){
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
	//...
	_zs->registerStaticMemberFunction<Number>("_mod",static_cast<ClassObject * (*)(ScriptEngine *_zs,zs_float *,Number * )>(&NumberZs_mod));
	_zs->registerStaticMemberFunction<Number>("_mod",static_cast<ClassObject * (*)(ScriptEngine *_zs,Number *,zs_float *)>(&NumberZs_mod));
	_zs->registerStaticMemberFunction<Number>("_mod",static_cast<ClassObject * (*)(ScriptEngine *_zs,Number *,Number * )>(&NumberZs_mod));
	//...
}
----
...
ClassObject * NumberZs_and(ScriptEngine *_zs,Number *_n1, Number *_n2){
	return _zs->newClassObject(new Number((zs_int)_n1->value & (zs_int)_n2->value));
}

ClassObject * NumberZs_and(ScriptEngine *_zs,Number *_n1, zs_float *_n2){
	return _zs->newClassObject(new Number((zs_int)_n1->value & (zs_int)*_n2));
}

ClassObject * NumberZs_and(ScriptEngine *_zs,zs_float *_n1, Number * _n2){
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
	//...
	_zs->registerStaticMemberFunction<Number>("_and",static_cast<ClassObject * (*)(ScriptEngine *_zs,zs_float *,Number * )>(&NumberZs_and));
	_zs->registerStaticMemberFunction<Number>("_and",static_cast<ClassObject * (*)(ScriptEngine *_zs,Number *,zs_float *)>(&NumberZs_and));
	_zs->registerStaticMemberFunction<Number>("_and",static_cast<ClassObject * (*)(ScriptEngine *_zs,Number *,Number * )>(&NumberZs_and));
	//...
}
----
...
ClassObject * NumberZs_or(ScriptEngine *_zs,Number *_n1, Number *_n2){
	return _zs->newClassObject(new Number((zs_int)_n1->value | (zs_int)_n2->value));
}

ClassObject * NumberZs_or(ScriptEngine *_zs,Number *_n1, zs_float *_n2){
	return _zs->newClassObject(new Number((zs_int)_n1->value | (zs_int)*_n2));
}

ClassObject * NumberZs_or(ScriptEngine *_zs,zs_float *_n1, Number * _n2){
	return _zs->newClassObject(new Number((zs_int)*_n1 | (zs_int)_n2->value));
}
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
	//...
	_zs->registerStaticMemberFunction<Number>("_or",static_cast<ClassObject * (*)(ScriptEngine *_zs,zs_float *,Number * )>(&NumberZs_or));
	_zs->registerStaticMemberFunction<Number>("_or",static_cast<ClassObject * (*)(ScriptEngine *_zs,Number *,zs_float *)>(&NumberZs_or));
	_zs->registerStaticMemberFunction<Number>("_or",static_cast<ClassObject * (*)(ScriptEngine *_zs,Number *,Number * )>(&NumberZs_or));
	//...
}
----
...
ClassObject * NumberZs_xor(ScriptEngine *_zs,Number *_n1, Number *_n2){
	return _zs->newClassObject(new Number((zs_int)_n1->value ^ (zs_int)_n2->value));
}

ClassObject * NumberZs_xor(ScriptEngine *_zs,Number *_n1, zs_float *_n2){
	return _zs->newClassObject(new Number((zs_int)_n1->value ^ (zs_int)*_n2));
}

ClassObject * NumberZs_xor(ScriptEngine *_zs,zs_float *_n1, Number * _n2){
	return _zs->newClassObject(new Number((zs_int)*_n1 ^ (zs_int)_n2->value));
}
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
	//...
	_zs->registerStaticMemberFunction<Number>("_xor",static_cast<ClassObject * (*)(ScriptEngine *_zs,zs_float *,Number * )>(&NumberZs_xor));
	_zs->registerStaticMemberFunction<Number>("_xor",static_cast<ClassObject * (*)(ScriptEngine *_zs,Number *,zs_float *)>(&NumberZs_xor));
	_zs->registerStaticMemberFunction<Number>("_xor",static_cast<ClassObject * (*)(ScriptEngine *_zs,Number *,Number * )>(&NumberZs_xor));
	//...
}
----
...
ClassObject * NumberZs_shl(ScriptEngine *_zs,Number *_n1, Number *_n2){
	return _zs->newClassObject(new Number((zs_int)_n1->value << (zs_int)_n2->value));
}

ClassObject * NumberZs_shl(ScriptEngine *_zs,Number *_n1, zs_float *_n2){
	return _zs->newClassObject(new Number((zs_int)_n1->value << (zs_int)*_n2));
}

ClassObject * NumberZs_shl(ScriptEngine *_zs,zs_float *_n1, Number *_n2){
	return _zs->newClassObject(new Number((zs_int)*_n1 << (zs_int)_n2->value));
}
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
	//...
	_zs->registerStaticMemberFunction<Number>("_shl",static_cast<ClassObject * (*)(ScriptEngine *_zs,zs_float *,Number * )>(&NumberZs_shl));
	_zs->registerStaticMemberFunction<Number>("_shl",static_cast<ClassObject * (*)(ScriptEngine *_zs,Number *,zs_float *)>(&NumberZs_shl));
	_zs->registerStaticMemberFunction<Number>("_shl",static_cast<ClassObject * (*)(ScriptEngine *_zs,Number *,Number * )>(&NumberZs_shl));
	//...
}
----
...
ClassObject * NumberZs_shr(ScriptEngine *_zs,Number *_n1, Number *_n2){
	return _zs->newClassObject(new Number((zs_int)_n1->value >> (zs_int)_n2->value));
}

ClassObject * NumberZs_shr(ScriptEngine *_zs,Number *_n1, zs_float *_n2){
	return _zs->newClassObject(new Number((zs_int)_n1->value >> (zs_int)*_n2));
}

ClassObject * NumberZs_shr(ScriptEngine *_zs,zs_float *_n1, Number *_n2){
	return _zs->newClassObject(new Number((zs_int)*_n1 >> (zs_int)_n2->value));
}
...
void NumberZs_register(zetscript::ScriptEngine *_zs){
	//...
	_zs->registerStaticMemberFunction<Number>("_shr",static_cast<ClassObject * (*)(ScriptEngine *_zs,zs_float *,Number * )>(&NumberZs_shr));
	_zs->registerStaticMemberFunction<Number>("_shr",static_cast<ClassObject * (*)(ScriptEngine *_zs,Number *,zs_float * )>(&NumberZs_shr));
	_zs->registerStaticMemberFunction<Number>("_shr",static_cast<ClassObject * (*)(ScriptEngine *_zs,Number *,Number * )>(&NumberZs_shr));
	//...
}
----
