...
the ZetScript API allows to register static and member metamethods in aim to define operators as we could see in _xref:language_class.adoc#_metamethods[chapter 2 class metamethods]_.
...
The following code defines two functions performs an assignment from _xref:language_data_types.adoc#&lowbar;float[Float]_ value or _Number_ object respectively,
