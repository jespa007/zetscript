...
[source,cpp]
----
void RegisteredType_addset(ScriptEngine *_script_engine, RegisteredType *_this,ParamType *_value);
----
...
void NumberZs_addset(ScriptEngine *_script_engine, Number *_this,zs_float *_n){
	_this->value+=*_n;
}

void NumberZs_addset(ScriptEngine *_script_engine, Number *_this,Number *_n){
	_this->value+=_n->value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_script_engine){
	...
	//...
	_script_engine->registerMemberFunction<Number>("_addset",static_cast<void (*)(ScriptEngine *_script_engine,Number *,zs_float *)>(&NumberZs_addset));

	_script_engine->registerMemberFunction<Number>("_addset",static_cast<void (*)(ScriptEngine *_script_engine,Number *,Number * )>(&NumberZs_addset));
	//...
...
[source,cpp]
----
void RegisteredType_subset(ScriptEngine *_script_engine, RegisteredType *_this,ParamType *_value);
----
...
void NumberZs_subset(ScriptEngine *_script_engine, Number *_this,zs_float *_n){
	_this->value-=*_n;
}

void NumberZs_subset(ScriptEngine *_script_engine, Number *_this,Number *_n){
	_this->value-=_n->value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_script_engine){
	//...
	_script_engine->registerMemberFunction<Number>("_subset",static_cast<void (*)(ScriptEngine *_script_engine,Number *,zs_float *)>(&NumberZs_subset));

	_script_engine->registerMemberFunction<Number>("_subset",static_cast<void (*)(ScriptEngine *_script_engine,Number *,Number * )>(&NumberZs_subset));
	//...
}
----
...
[source,cpp]
----
void RegisteredType_mulset(ScriptEngine *_script_engine, RegisteredType *_this,ParamType *_value);
----
...
void NumberZs_mulset(ScriptEngine *_script_engine, Number *_this,zs_float *_n){
	_this->value-=*_n;
}

void NumberZs_mulset(ScriptEngine *_script_engine, Number *_this,Number *_n){
	_this->value-=_n->value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_script_engine){
	//...
	_script_engine->registerMemberFunction<Number>("_mulset",static_cast<void (*)(ScriptEngine *_script_engine,Number *,zs_float *)>(&NumberZs_mulset));

	_script_engine->registerMemberFunction<Number>("_mulset",static_cast<void (*)(ScriptEngine *_script_engine,Number *,Number * )>(&NumberZs_mulset));
	//...
}
----
...
[source,cpp]
----
void RegisteredType_divset(ScriptEngine *_script_engine, RegisteredType *_this,ParamType *_value);
----
...
void NumberZs_divset(ScriptEngine *_script_engine, Number *_this,zs_float *_n){
	_this->value-=*_n;
}

void NumberZs_divset(ScriptEngine *_script_engine, Number *_this,Number *_n){
	_this->value-=_n->value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_script_engine){
	...
	//...
	_script_engine->registerMemberFunction<Number>("_divset",static_cast<void (*)(ScriptEngine *_script_engine,Number *,zs_float *)>(&NumberZs_divset));

	_script_engine->registerMemberFunction<Number>("_divset",static_cast<void (*)(ScriptEngine *_script_engine,Number *,Number * )>(&NumberZs_divset));
	//...
}
----
...
[source,cpp]
----
void RegisteredType_modset(ScriptEngine *_script_engine, RegisteredType *_this,ParamType *_value);
----
...
void NumberZs_modset(ScriptEngine *_script_engine, Number *_this,zs_float *_n){
	_this->value-=*_n;
}

void NumberZs_modset(ScriptEngine *_script_engine, Number *_this,Number *_n){
	_this->value-=_n->value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_script_engine){
	...
	//...
	_script_engine->registerMemberFunction<Number>("_modset",static_cast<void (*)(ScriptEngine *_script_engine,Number *,zs_float *)>(&NumberZs_modset));

	_script_engine->registerMemberFunction<Number>("_modset",static_cast<void (*)(ScriptEngine *_script_engine,Number *,Number * )>(&NumberZs_modset));
	//...
...
[source,cpp]
----
void RegisteredType_andset(ScriptEngine *_script_engine, RegisteredType *_this,ParamType *_value);
----
...
void NumberZs_andset(ScriptEngine *_script_engine, Number *_this,zs_float *_n){
	_this->value-=*_n;
}

void NumberZs_andset(ScriptEngine *_script_engine, Number *_this,Number *_n){
	_this->value-=_n->value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_script_engine){
	...
	//...
	_script_engine->registerMemberFunction<Number>("_andset",static_cast<void (*)(ScriptEngine *_script_engine,Number *,zs_float *)>(&NumberZs_andset));

	_script_engine->registerMemberFunction<Number>("_andset",static_cast<void (*)(ScriptEngine *_script_engine,Number *,Number * )>(&NumberZs_andset));
	//...
...
[source,cpp]
----
void RegisteredType_orset(ScriptEngine *_script_engine, RegisteredType *_this,ParamType *_value);
----
...
void NumberZs_orset(ScriptEngine *_script_engine, Number *_this,zs_float *_n){
	_this->value-=*_n;
}

void NumberZs_orset(ScriptEngine *_script_engine, Number *_this,Number *_n){
	_this->value-=_n->value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_script_engine){
	...
	//...
	_script_engine->registerMemberFunction<Number>("_orset",static_cast<void (*)(ScriptEngine *_script_engine,Number *,zs_float *)>(&NumberZs_orset));

	_script_engine->registerMemberFunction<Number>("_orset",static_cast<void (*)(ScriptEngine *_script_engine,Number *,Number * )>(&NumberZs_orset));
	//...
...
[source,cpp]
----
void RegisteredType_xorset(ScriptEngine *_script_engine, RegisteredType *_this,ParamType *_value);
----
...
void NumberZs_xorset(ScriptEngine *_script_engine, Number *_this,zs_float *_n){
	_this->value-=*_n;
}

void NumberZs_xorset(ScriptEngine *_script_engine, Number *_this,Number *_n){
	_this->value-=_n->value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_script_engine){
	...
	//...
	_script_engine->registerMemberFunction<Number>("_xorset",static_cast<void (*)(ScriptEngine *_script_engine,Number *,zs_float *)>(&NumberZs_xorset));

	_script_engine->registerMemberFunction<Number>("_xorset",static_cast<void (*)(ScriptEngine *_script_engine,Number *,Number * )>(&NumberZs_xorset));
	//...
...
[source,cpp]
----
void RegisteredType_shrset(ScriptEngine *_script_engine, RegisteredType *_this,ParamType *_value);
----
...
void NumberZs_shrset(ScriptEngine *_script_engine, Number *_this,zs_float *_n){
	_this->value-=*_n;
}

void NumberZs_shrset(ScriptEngine *_script_engine, Number *_this,Number *_n){
	_this->value-=_n->value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_script_engine){
	...
	//...
	_script_engine->registerMemberFunction<Number>("_shrset",static_cast<void (*)(ScriptEngine *_script_engine,Number *,zs_float *)>(&NumberZs_shrset));

	_script_engine->registerMemberFunction<Number>("_shrset",static_cast<void (*)(ScriptEngine *_script_engine,Number *,Number * )>(&NumberZs_shrset));
	//...
...
[source,cpp]
----
void RegisteredType_shlset(ScriptEngine *_script_engine, RegisteredType *_this,ParamType *_value);
----
...
void NumberZs_shlset(ScriptEngine *_script_engine, Number *_this,zs_float *_n){
	_this->value-=*_n;
}

void NumberZs_shlset(ScriptEngine *_script_engine, Number *_this,Number *_n){
	_this->value-=_n->value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_script_engine){
	...
	//...
	_script_engine->registerMemberFunction<Number>("_shlset",static_cast<void (*)(ScriptEngine *_script_engine,Number *,zs_float *)>(&NumberZs_shlset));

	_script_engine->registerMemberFunction<Number>("_shlset",static_cast<void (*)(ScriptEngine *_script_engine,Number *,Number * )>(&NumberZs_shlset));
	//...
