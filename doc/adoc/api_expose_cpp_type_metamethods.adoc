...
ZetScript can register static and member functions in order to implement metamethods seen in <<language_class.adoc#_metamethods,Language Class Metamethods>>.
...
Return new type wrapped in __zetscript::ClassScriptObject__ with the value before perform post decrement operation
...
Return new type wrapped in __zetscript::ClassScriptObject__ with the value before perform post increment operation
...
Return new type wrapped in __zetscript::ClassScriptObject__ with the value after perform post increment operation
...
- ___script_engine__ : ScriptEngine instance
- ___this__ : The current instance
- ___value__ : A value to be set. Its type can be one defined in <<api_call_cpp_from_zetscript.adoc#_parameter_types,parameter types>>.
...
The following code defines three functions that performs __div__ operation from __Float__ value or __Number__ type,
...
Finally, the following code it shows an example of a script that performs ___div__ operation from a __Float__ and __Number__.
...
The following code defines three functions that performs __equ__ operation from __Float__ value or __Number__ type,
...
Next, each function _NumberZs_equ_ is registered as member metamethod ___equ__ through __ScriptEngine::registerMemberFunction__,
...
Finally, the following code it shows an example of a script that performs __equ__ operation from a __Float__ and __Number__.
...
The following code defines three functions that performs __gt__ operation from __Float__ value or __Number__ type,
...
Next, each function _NumberZs_gte_ is registered as member metamethod ___gte__ through __ScriptEngine::registerMemberFunction__,
...
Finally, the following code it shows an example of a script that performs __gte__ operation from a __Float__ and __Number__.
...
The following code defines three functions that performs __lt__ operation from __Float__ value or __Number__ type,
...
Finally, the following code it shows an example of a script that performs __lt__ operation from a __Float__ and __Number__.
...
Implements __less than or equal__ operator (aka \<= ) between first operand and second operand
...
The following code defines three functions that performs __lte__ operation from __Float__ value or __Number__ type,
...
Finally, the following code it shows an example of a script that performs __lte__ operation from a __Float__ and __Number__.
...
Implements __modulus__ operator (aka % ) between first operand and second operand
...
The following code defines three functions that performs __mod__ operation from __Float__ value or __Number__ type,
...
Next, each function _NumberZs_mod_ is registered as member metamethod ___mod__ through __ScriptEngine::registerMemberFunction__,
...
Finally, the following code it shows an example of a script that performs ___mod__ operation from a __Float__ and __Number__.
...
Implements __multiplication__ operator (aka * ) between first operand and second operand
...
The following code defines three functions that performs __mul__ operation from __Float__ value or __Number__ type,
...
Next, each function _NumberZs_mul_ is registered as member metamethod ___mul__ through __ScriptEngine::registerMemberFunction__,
...
Implements __not equal__ operator (aka != ) between first operand and second operand
...
Next, each function _NumberZs_nequ_ is registered as member metamethod ___nequ__ through __ScriptEngine::registerMemberFunction__,
...
Finally, the following code it shows an example of a script that performs __nequ__ operation from a __Float__ and __Number__.
...
The following code defines three functions that performs __OR__ operation from __Float__ value or __Number__ type,
...
Next, each function __NumberZs_or__ is registered as member metamethod ___OR__ through __ScriptEngine::registerMemberFunction__,
...
Finally, the following code it shows an example of a script that performs ___OR__ operation from a __Float__ and __Number__.
...
Implements __bitwise shift left__ operator (aka << ) between first operand and second operand
...
Next, each function __NumberZs_shl__ is registered as member metamethod ___shl__ through __ScriptEngine::registerMemberFunction__,
...
Finally, the following code it shows an example of a script that performs ___shl__ operation from a __Float__ and __Number__.
...
The following code defines three functions that performs __shr__ operation from __Float__ value or __Number__ type,
...
Next, each function __NumberZs_shr__ is registered as member metamethod ___shr__ through __ScriptEngine::registerMemberFunction__,
...
Finally, the following code it shows an example of a script that performs ___shr__ operation from a __Float__ and __Number__.
...
The following code defines three functions that performs __sub__ operation from __Float__ value or __Number__ type,
...
Next, each function _Num_berZs_sub_ is registered as member metamethod ___sub__ through __ScriptEngine::registerMemberFunction__,
...
Finally, the following code it shows an example of a script that performs ___sub__ operation from a __Float__ and __Number__.
...
The following code defines three functions that performs __XOR__ operation from __Float__ value or __Number__ type,
...
Next, each function __NumberZs_xor__ is registered as member metamethod ___XOR__ through __ScriptEngine::registerMemberFunction__,
...
Finally, the following code it shows an example of a script that performs ___XOR__ operation from a __Float__ and __Number__.
