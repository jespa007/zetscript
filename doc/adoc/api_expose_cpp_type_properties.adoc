...
[source,javascript]
----
void RegisteredTypeProperty_addset(ScriptEngine *_script_engine, RegisteredType *_this, ParamType *_value)
----
...
[source,cpp]
----
void NumberZs_value_addset(ScriptEngine *_script_engine,Number *_this,zs_float *_value){
	_this->value+=*_value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_script_engine){
	...
	_script_engine->registerMemberPropertyMetamethod<Number>("value","_addset",NumberZs_value_addset));
...
[source,javascript]
----
void RegisteredTypeProperty_subset(ScriptEngine *_script_engine, RegisteredType *_this, ParamType *_value)
----
...
void NumberZs_value_subset(ScriptEngine *_script_engine,Number *_this,zs_float *_value){
	_this->value-=*_value;
}
...
void NumberZs_register(zetscript::ScriptEngine *_script_engine){
	...
	_script_engine->registerMemberPropertyMetamethod<Number>("value","_subset",NumberZs_value_subset);
...
[source,javascript]
----
void RegisteredTypeProperty_mulset(ScriptEngine *_script_engine, RegisteredType *_this, ParamType *_value)
----
...
void NumberZs_value_mulset(ScriptEngine *_script_engine,Number *_this,zs_float *_value){
	_this->value*=*_value;
}
...
void NumberZs_register(zetscript::ScriptEngine *_script_engine){
	...
	_script_engine->registerMemberPropertyMetamethod<Number>("value","_mulset",NumberZs_value_mulset);
...
[source,javascript]
----
void RegisteredTypeProperty_divset(ScriptEngine *_script_engine, RegisteredType *_this, ParamType *_value)
----
...
void NumberZs_value_divset(ScriptEngine *_script_engine,Number *_this,zs_float *_value){
	_this->value/=*_value;
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_script_engine){
	...
	_script_engine->registerMemberPropertyMetamethod<Number>("value","_divset",NumberZs_value_divset);
...
[source,javascript]
----
void RegisteredTypeProperty_modset(ScriptEngine *_script_engine, RegisteredType *_this, ParamType *_value)
----
...
[source,cpp]
----
void NumberZs_value_modset(ScriptEngine *_script_engine,Number *_this,zs_float *_value){
...
void NumberZs_register(zetscript::ScriptEngine *_script_engine){
	...
	_script_engine->registerMemberPropertyMetamethod<Number>("value","_modset",NumberZs_value_modset);
...
[source,javascript]
----
void RegisteredTypeProperty_andset(ScriptEngine *_script_engine, RegisteredType *_this, ParamType *_value)
----
...
void NumberZs_value_andset(ScriptEngine *_script_engine,Number *_this,zs_float *_value){
...
void NumberZs_register(zetscript::ScriptEngine *_script_engine){
	...
	_script_engine->registerMemberPropertyMetamethod<Number>("value","_andset",NumberZs_value_andset);
...
[source,javascript]
----
void RegisteredTypeProperty_orset(ScriptEngine *_script_engine, RegisteredType *_this, ParamType *_value)
----
...
void NumberZs_value_orset(ScriptEngine *_script_engine,Number *_this,zs_float *_value){
	_this->value=(int)(_this->value)|(int)(*_value);
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_script_engine){
	...
	_script_engine->registerMemberPropertyMetamethod<Number>("value","_orset",NumberZs_value_orset);
...
[source,javascript]
----
void RegisteredTypeProperty_xorset(ScriptEngine *_script_engine, RegisteredType *_this, ParamType *_value)
----
...
void NumberZs_value_xorset(ScriptEngine *_script_engine,Number *_this,zs_float *_value){
	_this->value=(int)(_this->value)^(int)(*_value);
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_script_engine){
	...
	_script_engine->registerMemberPropertyMetamethod<Number>("value","_xorset",NumberZs_value_xorset);
...
[source,javascript]
----
void RegisteredTypeProperty_shrset(ScriptEngine *_script_engine, RegisteredType *_this, ParamType *_value)
----
...
void NumberZs_value_shrset(ScriptEngine *_script_engine,Number *_this,zs_float *_value){
	_this->value=(int)(_this->value)>>(int)(*_value);
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_script_engine){
	...
	_script_engine->registerMemberPropertyMetamethod<Number>("value","_shrset",NumberZs_value_shrset);
...
[source,javascript]
----
void RegisteredTypeProperty_shlset(ScriptEngine *_script_engine, RegisteredType *_this, ParamType *_value)
----
...
void NumberZs_value_shlset(ScriptEngine *_script_engine,Number *_this,zs_float *_value){
	_this->value=(int)(_this->value)<<(int)(*_value);
}
----
...
void NumberZs_register(zetscript::ScriptEngine *_script_engine){
	...
	_script_engine->registerMemberPropertyMetamethod<Number>("value","_shlset",NumberZs_value_shlset);
