...
[source,javascript]
----
include::../examples/scripts/function/function_rest_parameters.zs[]
----
...
[source,text]
----
include::../examples/scripts/function/function_rest_parameters_out.txt[]
----
...
[source,javascript]
----
include::../examples/scripts/function/function_parameter_by_reference.zs[]
----
...
[source,text]
----
include::../examples/scripts/function/function_parameter_by_reference_out.txt[]
----
