...
Return the value before perform post increment operation. The return value can be one defined in  xref:chapter_3_the_api_call_cpp_from_zetscript#_return_types[return types].
...
Return the value before perform post decrement operation. The return value can be one defined in  xref:chapter_3_the_api_call_cpp_from_zetscript#_return_types[return types].
...
Return the value before perform pre increment operation. The return value can be one defined in  xref:chapter_3_the_api_call_cpp_from_zetscript#_return_types[return types].
...
Return the value before perform pre decrement operation. The return value can be one defined in  xref:chapter_3_the_api_call_cpp_from_zetscript#_return_types[return types].
