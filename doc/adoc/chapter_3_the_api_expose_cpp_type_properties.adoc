...
the ZetScript API allows to register class properties as we could see in _xref:chapter_2_the_language_class.adoc#_properties[chapter 2 class properties]_.
