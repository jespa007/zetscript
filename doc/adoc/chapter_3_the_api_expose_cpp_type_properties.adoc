...
===== Register const property functions

Returns the value of the property as constant.
...
Next, the function is registered through _registerConstMemberProperty_,
...
Next, the function is registered as member metamethod __get__ through _registerMemberPropertyMetamethod_,
...
Next, the function is registered as member metamethod _set_ through _registerMemberPropertyMetamethod_,
...
Next, the function is registered as member metamethod __addset__ through _registerMemberPropertyMetamethod_,
...
Next, the function is registered as member metamethod __subset__ through _registerMemberPropertyMetamethod_,
...
Next, the function is registered as member metamethod __mulset__ through _registerMemberPropertyMetamethod_,
...
Next, the function is registered as member metamethod __divset__ through _registerMemberPropertyMetamethod_,
...
Next, the function is registered as member metamethod __andset__ through _registerMemberPropertyMetamethod_,
...
Next, the function is registered as member metamethod __orset__ through _registerMemberPropertyMetamethod_,
...
Next, the function is registered as member metamethod __xorset__ through _registerMemberPropertyMetamethod_,
...
Next, the function is registered as member metamethod __shrset__ through _registerMemberPropertyMetamethod_,
...
Next, the function is registered as member metamethod __shlset__ through _registerMemberPropertyMetamethod_,
...
Return the value before perform post increment operation. The return value can be one defined in  <<ZetScript built-in return types>> or a pointer of other xref:chapter_3_the_api_expose_cpp_types#_register_a_type[registered type].
...
Next, the function is registered as member metamethod __postinc__ through _registerMemberPropertyMetamethod_,
...
Return the value before perform post decrement operation. The return value can be one defined in  <<ZetScript built-in return types>> or a pointer of other xref:chapter_3_the_api_expose_cpp_types#_register_a_type[registered type].
...
Next, the function is registered as member metamethod __postdec__ through _registerMemberPropertyMetamethod_,
...
Return the value before perform pre increment operation. The return value can be one defined in  <<ZetScript built-in return types>> or a pointer of other xref:chapter_3_the_api_expose_cpp_types#_register_a_type[registered type].
...
Next, the function is registered as member metamethod __preinc__ through _registerMemberPropertyMetamethod_,
...
Return the value before perform pre decrement operation. The return value can be one defined in  <<ZetScript built-in return types>> or a pointer of other xref:chapter_3_the_api_expose_cpp_types#_register_a_type[registered type].
...
Next, the function is registered as member metamethod __predec__ through _registerMemberPropertyMetamethod_,
