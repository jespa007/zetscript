...
- __zs_ : ZetScript context
- __this_ : The current instance
- __value_ : Value or variable as right operand. Its type can be a pointer of one defined in  xref:chapter_3_the_api_types#_built_in_types[built-in types] or a pointer of other registered type.
