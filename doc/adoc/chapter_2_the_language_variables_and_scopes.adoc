...
By default, any declared variable is set as _xref:chapter_2_the_language_data_types#_undefined[undefined]_, that tells a variable was not properly initialized. 
