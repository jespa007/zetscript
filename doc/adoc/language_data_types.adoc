...
The type _Float_ is represented as IEEE-754 floating point numbers in 32-bit or 64 bit depending whether ZetScript is compiled for 32bits or 64bits. A variable is initialized as _Float_ once it assigns a decimal or scientific value notation forms.
...
A _Boolean_ as _true_ if __value_ matches starting string, otherwise it returns _false_.
...
A _Boolean_ as _true_ if __value_ matches ending string, otherwise it returns _false_.
...
For more information about _Function_ go to xref:chapter_2_the_language_function.adoc#_the_function[section 2.9]. 
...
For more information about _Class_ go to xref:chapter_2_the_language_class.adoc#_the_class[section 2.10]. 
