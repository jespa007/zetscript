...
To bind a ZetScript function that returns a <<language_data_types.adoc#&#95;boolean,Boolean>> it must specify _bool_ return type on its function signature.
...
To bind a ZetScript function that returns a <<language_data_types.adoc#&#95;integer,Integer>> it must specify _zetscript::zs_int_ return type on its function signature.
...
To bind a ZetScript function that returns a <<language_data_types.adoc#\_float,Float>> it must specify _zetscript::zs_float_ return type on its function signature.
...
To bind a ZetScript function that returns a <<language_data_types.adoc#\_string,String>> it can specify _zetscript::String_ return type on its function signature.
...
To bind a ZetScript function that returns a <<language_data_types.adoc#\_string,String>> it can specify _zetscript::StringScriptObject &#42;_ return type on its function signature.
...
To bind a ZetScript function that returns a <<language_data_types.adoc#\_array,Array>> it must specify _ArrayScriptObject &#42;_ return type on its function signature.
...
To bind a ZetScript function that returns a <<language_data_types.adoc#\_object,Object>> it must specify _ObjectScriptObject &#42;_ return type on its function signature.
...
To bind a ZetScript function that accepts a <<language_data_types.adoc#&#95;boolean,Boolean>> it must specify _bool &#42;_ as parameter type on its function signature.
...
To bind a ZetScript function that accepts a <<language_data_types.adoc#&#95;integer,Integer>> it must specify _zs_int_ or _zs_int &#42;_ as parameter type on its function signature.
...
To bind a ZetScript function that accepts a <<language_data_types.adoc#\_float,Float>> it must specify or _zs_float &#42;_ as parameter type on its function signature.
...
To bind a ZetScript function that accepts a <<language_data_types.adoc#\_string,String>> it can specify _const char &#42;_ as parameter type on its function signature.
...
To bind a ZetScript function that accepts a <<language_data_types.adoc#\_string,String>> it can specify _String &#42;_ as parameter type on its function signature.
...
To bind a ZetScript function that accepts a <<language_data_types.adoc#\_string,String>> it can specify _StringScriptObject &#42;_ as parameter type on its function signature.
...
To bind a ZetScript function that accepts a <<language_data_types.adoc#\_array,Array>> it must specify or _ArrayScriptObject &#42;_ as parameter type on its function signature.
...
To bind a ZetScript function that accepts a <<language_data_types.adoc#\_object,Object>> it must specify _ObjectScriptObject &#42;_ as parameter type on its function signature.
