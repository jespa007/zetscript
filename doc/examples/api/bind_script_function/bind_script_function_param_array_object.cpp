...
int main()
{
    ...
    auto printConcat=se.bindScriptFunction<void(ArrayScriptObject * _value1, ArrayScriptObject * _value2)>("printConcat");

    // Prepare param values
    auto array1=se.newArrayScriptObject();
    auto array2=se.newArrayScriptObject();
