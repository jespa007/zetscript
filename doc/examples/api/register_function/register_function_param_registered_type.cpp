...
void NumberZs_set_value(ScriptEngine *_se, Number *_this, zs_float *_value){
	_this->value=*_value;
}
...
void mul10Number(ScriptEngine *_se, Number *_number){
	// initialize x and y
	_number->value*=10;
}
...
int main(){
	...
	se.registerMemberPropertyMetamethod<Number>("value","_set",NumberZs_set_value);
    ...
    se.registerFunction("mul10Number",mul10Number);
