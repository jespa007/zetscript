...
typedef enum{
	...
	BIT_INSTRUCTION_PROPERTY_ILOAD_R_ACCESS_THIS_MEMBER,									// 0x0010   // for register access type
	BIT_INSTRUCTION_PROPERTY_ILOAD_KR,														// 0x0020
	BIT_INSTRUCTION_PROPERTY_ILOAD_RK,														// 0x0040
	BIT_INSTRUCTION_PROPERTY_ILOAD_RR,														// 0x0080
	BIT_INSTRUCTION_PROPERTY_ZS_INT,														// 0x0100
	BIT_INSTRUCTION_PROPERTY_ZS_FLOAT,														// 0x0200
	BIT_INSTRUCTION_PROPERTY_BOOL,															// 0x0400
	BIT_INSTRUCTION_PROPERTY_STRING,														// 0x0800
...
#define	MSK_INSTRUCTION_PROPERTY_ILOAD_R_ACCESS_LOCAL			(0x1<<BIT_INSTRUCTION_PROPERTY_ILOAD_R_ACCESS_LOCAL) // LOCAL,   // by default
#define	MSK_INSTRUCTION_PROPERTY_ILOAD_R_ACCESS_THIS_MEMBER		(0x1<<BIT_INSTRUCTION_PROPERTY_ILOAD_R_ACCESS_THIS_MEMBER) // THIS,   // by default
...
// BYTE_CODE_CALL TYPE
#define MSK_INSTRUCTION_ADD_PROPERTY_IF_NOT_EXIST			(0x1 << BIT_INSTRUCTION_ADD_PROPERTY_IF_NOT_EXIST)
...
#define MSK_INSTRUCTION_PROPERTY_ILOAD						(MSK_INSTRUCTION_PROPERTY_ILOAD_K|MSK_INSTRUCTION_PROPERTY_ILOAD_R|MSK_INSTRUCTION_PROPERTY_ILOAD_KR|MSK_INSTRUCTION_PROPERTY_ILOAD_RK|MSK_INSTRUCTION_PROPERTY_ILOAD_RR)

//#define MSK_INSTRUCTION_PROPERTY_NEXT_FIELD_LOAD			(0x1 << BIT_INSTRUCTION_PROPERTY_NEXT_FIELD_LOAD)

//#define MSK_INSTRUCTION_PROPERTY_POP_TWO					(0x1 << BIT_INSTRUCTION_PROPERTY_POP_TWO)

#define MSK_INSTRUCTION_PROPERTY_ZS_INT						(0x1 << BIT_INSTRUCTION_PROPERTY_ZS_INT)
#define MSK_INSTRUCTION_PROPERTY_ZS_FLOAT					(0x1 << BIT_INSTRUCTION_PROPERTY_ZS_FLOAT)
#define MSK_INSTRUCTION_PROPERTY_BOOL						(0x1 << BIT_INSTRUCTION_PROPERTY_BOOL)
#define MSK_INSTRUCTION_PROPERTY_STRING						(0x1 << BIT_INSTRUCTION_PROPERTY_STRING)

#define INSTRUCTION_CONST_TO_STK_CONST_PROPERTY(properties)\
	 (properties) & MSK_INSTRUCTION_PROPERTY_ZS_INT ? MSK_STK_PROPERTY_ZS_INT \
	:(properties) & MSK_INSTRUCTION_PROPERTY_BOOL ? MSK_STK_PROPERTY_BOOL \
	:(properties) & MSK_INSTRUCTION_PROPERTY_ZS_FLOAT ? MSK_STK_PROPERTY_ZS_FLOAT \
	:(properties) & MSK_INSTRUCTION_PROPERTY_STRING ? MSK_STK_PROPERTY_PTR_STK \
	:0
