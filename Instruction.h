...
typedef enum{
	...
	BIT_INSTRUCTION_PROPERTY_ILOAD_R_LOCAL_ACCESS,											// 0x0008   // for register access type
	BIT_INSTRUCTION_PROPERTY_ILOAD_KR,														// 0x0010
	BIT_INSTRUCTION_PROPERTY_ILOAD_RK,														// 0x0020
	BIT_INSTRUCTION_PROPERTY_ILOAD_RR,														// 0x0040
	BIT_INSTRUCTION_PROPERTY_ZS_INT,														// 0x0080
	BIT_INSTRUCTION_PROPERTY_FLOAT,															// 0x0100
	BIT_INSTRUCTION_PROPERTY_BOOL,															// 0x0200
	BIT_INSTRUCTION_PROPERTY_STRING,														// 0x0400
...
#define	MSK_INSTRUCTION_PROPERTY_ILOAD_R_LOCAL_ACCESS			(0x1<<BIT_INSTRUCTION_PROPERTY_ILOAD_R_LOCAL_ACCESS) //GLOBAL_SCOPE,   // by default
