...
typedef enum{
	...
	BIT_INSTRUCTION_PROPERTY_POP_TWO,														// 0x0200
	BIT_INSTRUCTION_PROPERTY_ZS_INT,													// 0x0400
	BIT_INSTRUCTION_PROPERTY_FLOAT,													// 0x0800
	BIT_INSTRUCTION_PROPERTY_BOOL,														// 0x1000
	BIT_INSTRUCTION_PROPERTY_STRING,													// 0x2000
