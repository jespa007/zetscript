...
typedef enum{
	...
	BIT_INSTRUCTION_PROPERTY_FLOAT,															// 0x0200
...
#define MSK_INSTRUCTION_PROPERTY_FLOAT						(0x1 << BIT_INSTRUCTION_PROPERTY_FLOAT)
...
#define INSTRUCTION_CONST_TO_STK_CONST_PROPERTY(properties)\
	...
	:(properties) & MSK_INSTRUCTION_PROPERTY_FLOAT ? MSK_STK_PROPERTY_FLOAT \
	:(properties) & MSK_INSTRUCTION_PROPERTY_STRING ? MSK_STK_PROPERTY_SCRIPT_OBJECT \
	:0
