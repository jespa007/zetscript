...
typedef enum{
	...
	BIT_INSTRUCTION_PROPERTY_SCOPE_TYPE_FIRST = BIT_INSTRUCTION_PROPERTY_PRE_POST_MAX,
	BIT_INSTRUCTION_PROPERTY_SCOPE_TYPE_LOCAL = BIT_INSTRUCTION_PROPERTY_SCOPE_TYPE_FIRST, 	// 0x0040
	BIT_INSTRUCTION_PROPERTY_SCOPE_TYPE_THIS,												// 0x0080
	BIT_INSTRUCTION_PROPERTY_SCOPE_TYPE_ACCESS,												// 0x0100
	BIT_INSTRUCTION_PROPERTY_SCOPE_TYPE_LAST,
	//-- BYTE_CODE_CALL TYPE
	BIT_INSTRUCTION_PROPERTY_POP_ONE= BIT_INSTRUCTION_PROPERTY_SCOPE_TYPE_LAST,				// 0x0200
	BIT_INSTRUCTION_PROPERTY_START_EXPRESSION,												// 0x0400
...
#define MSK_INSTRUCTION_PROPERTY_SCOPE_TYPE					(((0x1<<(BIT_INSTRUCTION_PROPERTY_SCOPE_TYPE_LAST-BIT_INSTRUCTION_PROPERTY_SCOPE_TYPE_FIRST))-1)<<(BIT_INSTRUCTION_PROPERTY_SCOPE_TYPE_FIRST))
