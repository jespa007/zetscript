...
int main(){
	...
	zs->registerNativeFunctionMember<MyClass>("function0",&MyClass::function0); // register function0 named function1 in script side as function member.
	zs->registerNativeFunctionMember<MyClass>("function1",&MyClass::function1); // register function1 named function1 in script side as function member.
