...
#define TEST_CONSTANT_BOOL_EXPRESSION(_script_engine,str_expr, expected_value) 	test_constant_bool_expression(_script_engine,str_expr, expected_value)
#define TEST_CONSTANT_INT_EXPRESSION(_script_engine,str_expr, expected_value) 		test_constant_int_expression(_script_engine,str_expr, expected_value)
#define TEST_CONSTANT_FLOAT_EXPRESSION(_script_engine,str_expr, expected_value) 	test_constant_float_expression(_script_engine,str_expr, expected_value)
#define TEST_CONSTANT_STRING_EXPRESSION(str_expr, expected_value) 		test_constant_string_expression(expected_value,str_expr)

#define TEST_ARITHMETIC_INT_EXPRESSION(_script_engine,expr) 						test_arithmetic_int_expression(_script_engine,expr,ZS_STR(expr))
#define TEST_ARITHMETIC_FLOAT_EXPRESSION(_script_engine,val1,print_warnings) 		test_arithmetic_float_expression(_script_engine,(zetscript::zs_float)(val1),ZS_STR(val1)";",print_warnings)
#define TEST_ARITHMETIC_BOOL_EXPRESSION(_script_engine,val1) 						test_arithmetic_bool_expression(_script_engine,val1,ZS_STR(val1))
#define TEST_ARITHMETIC_ASSIGNRING_EXPRESSION(_script_engine,val1,op, val2)			test_arithmetitoConstCharing_expression(_script_engine,zetscript::String(val1) op val2,ZS_STR(val1)ZS_STR(op)val2)
#define COMPLETE_TEST_ARITHMETIC_FLOAT_OP(_script_engine,val1,val2) 				_complete_test_arithmetic_float_op(_script_engine,val1, val2,"return %s%s%s")
...
void test_constant_int_expression(zetscript::ScriptEngine *_script_engine, const char *str_expr, zetscript::zs_int expected_value);
